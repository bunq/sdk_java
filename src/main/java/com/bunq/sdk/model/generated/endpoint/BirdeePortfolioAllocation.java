 ...
 */
public class BirdeePortfolioAllocation extends BunqModel {
  ...
  /**
   */
  public static BirdeePortfolioAllocation fromJsonReader(JsonReader reader) {
    return fromJsonReader(BirdeePortfolioAllocation.class, reader);
  }
