...
/**
 */
public class TaxResidentObject extends BunqModel {
  ...
  public TaxResidentObject() {
  this(null, null, null);
  }

  public TaxResidentObject(String country) {
  ...
  public TaxResidentObject(String country, String taxNumber, String status) {
  ...
  /**
   */
  public static TaxResidentObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(TaxResidentObject.class, reader);
  }
