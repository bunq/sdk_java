...
/**
 */
public class ShareDetailDraftPaymentObject extends BunqModel {
  ...
  public ShareDetailDraftPaymentObject() {
  this(null, null, null, null);
  }

  public ShareDetailDraftPaymentObject(Boolean makeDraftPayments) {
  this(makeDraftPayments, null, null, null);
  }

  public ShareDetailDraftPaymentObject(Boolean makeDraftPayments, Boolean viewBalance) {
  this(makeDraftPayments, viewBalance, null, null);
  }

  public ShareDetailDraftPaymentObject(Boolean makeDraftPayments, Boolean viewBalance, Boolean viewOldEvents) {
  this(makeDraftPayments, viewBalance, viewOldEvents, null);
  }

  public ShareDetailDraftPaymentObject(Boolean makeDraftPayments, Boolean viewBalance, Boolean viewOldEvents, Boolean viewNewEvents) {
  ...
  /**
   */
  public static ShareDetailDraftPaymentObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(ShareDetailDraftPaymentObject.class, reader);
  }
