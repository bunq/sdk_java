 ...
 */
public class NoteAttachmentOpenBankingMerchantTransactionApiObject extends BunqModel {
...
requestMap.put(FIELD_DESCRIPTION, description);
  ...
  public static BunqResponse<List<NoteAttachmentOpenBankingMerchantTransactionApiObject>> list(Integer openBankingMerchantTransactionId, Integer monetaryAccountId, Map<String, String> params, Map<String, String> customHeaders) {
    ...
    return fromJsonList(NoteAttachmentOpenBankingMerchantTransactionApiObject.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<List<NoteAttachmentOpenBankingMerchantTransactionApiObject>> list() {
  ...
  public static BunqResponse<NoteAttachmentOpenBankingMerchantTransactionApiObject> get(Integer openBankingMerchantTransactionId, Integer noteAttachmentOpenBankingMerchantTransactionId, Integer monetaryAccountId, Map<String, String> params, Map<String, String> customHeaders) {
    ...
    return fromJson(NoteAttachmentOpenBankingMerchantTransactionApiObject.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<NoteAttachmentOpenBankingMerchantTransactionApiObject> get() {
  ...
  /**
   */
  public static NoteAttachmentOpenBankingMerchantTransactionApiObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(NoteAttachmentOpenBankingMerchantTransactionApiObject.class, reader);
  }
