 ...
 */
public class NoteAttachmentAdyenCardTransaction extends BunqModel {
  ...
  public NoteAttachmentAdyenCardTransaction() {
  this(null, null);
  }

  public NoteAttachmentAdyenCardTransaction(Integer attachmentId) {
  this(attachmentId, null);
  }

  public NoteAttachmentAdyenCardTransaction(Integer attachmentId, String description) {
...
requestMap.put(FIELD_DESCRIPTION, description);
  ...
  /**
   */
  public static BunqResponse<NoteAttachmentAdyenCardTransaction> delete(Integer adyenCardTransactionId, Integer noteAttachmentAdyenCardTransactionId, Integer monetaryAccountId, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
  ...
  public static BunqResponse<NoteAttachmentAdyenCardTransaction> delete(Integer adyenCardTransactionId) {
    return delete(adyenCardTransactionId, null, null, null);
  }

  public static BunqResponse<NoteAttachmentAdyenCardTransaction> delete(Integer adyenCardTransactionId, Integer noteAttachmentAdyenCardTransactionId) {
    return delete(adyenCardTransactionId, noteAttachmentAdyenCardTransactionId, null, null);
  }

  public static BunqResponse<NoteAttachmentAdyenCardTransaction> delete(Integer adyenCardTransactionId, Integer noteAttachmentAdyenCardTransactionId, Integer monetaryAccountId) {
    return delete(adyenCardTransactionId, noteAttachmentAdyenCardTransactionId, monetaryAccountId, null);
  }

  /**
   */
  public static BunqResponse<List<NoteAttachmentAdyenCardTransaction>> list(Integer adyenCardTransactionId, Integer monetaryAccountId, Map<String, String> params, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
    ...
    return fromJsonList(NoteAttachmentAdyenCardTransaction.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<List<NoteAttachmentAdyenCardTransaction>> list() {
    return list(null, null, null, null);
  }

  public static BunqResponse<List<NoteAttachmentAdyenCardTransaction>> list(Integer adyenCardTransactionId) {
    return list(adyenCardTransactionId, null, null, null);
  }

  public static BunqResponse<List<NoteAttachmentAdyenCardTransaction>> list(Integer adyenCardTransactionId, Integer monetaryAccountId) {
    return list(adyenCardTransactionId, monetaryAccountId, null, null);
  }

  public static BunqResponse<List<NoteAttachmentAdyenCardTransaction>> list(Integer adyenCardTransactionId, Integer monetaryAccountId, Map<String, String> params) {
    return list(adyenCardTransactionId, monetaryAccountId, params, null);
  }

  /**
   */
  public static BunqResponse<NoteAttachmentAdyenCardTransaction> get(Integer adyenCardTransactionId, Integer noteAttachmentAdyenCardTransactionId, Integer monetaryAccountId, Map<String, String> params, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
    ...
    return fromJson(NoteAttachmentAdyenCardTransaction.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<NoteAttachmentAdyenCardTransaction> get() {
    return get(null, null, null, null, null);
  }

  public static BunqResponse<NoteAttachmentAdyenCardTransaction> get(Integer adyenCardTransactionId) {
    return get(adyenCardTransactionId, null, null, null, null);
  }

  public static BunqResponse<NoteAttachmentAdyenCardTransaction> get(Integer adyenCardTransactionId, Integer noteAttachmentAdyenCardTransactionId) {
    return get(adyenCardTransactionId, noteAttachmentAdyenCardTransactionId, null, null, null);
  }

  public static BunqResponse<NoteAttachmentAdyenCardTransaction> get(Integer adyenCardTransactionId, Integer noteAttachmentAdyenCardTransactionId, Integer monetaryAccountId) {
    return get(adyenCardTransactionId, noteAttachmentAdyenCardTransactionId, monetaryAccountId, null, null);
  }

  public static BunqResponse<NoteAttachmentAdyenCardTransaction> get(Integer adyenCardTransactionId, Integer noteAttachmentAdyenCardTransactionId, Integer monetaryAccountId, Map<String, String> params) {
  ...
  /**
   */
  public static NoteAttachmentAdyenCardTransaction fromJsonReader(JsonReader reader) {
    return fromJsonReader(NoteAttachmentAdyenCardTransaction.class, reader);
  }
