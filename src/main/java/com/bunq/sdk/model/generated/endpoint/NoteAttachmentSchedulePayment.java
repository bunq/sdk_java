 ...
 */
public class NoteAttachmentSchedulePayment extends BunqModel {
    ...
    public NoteAttachmentSchedulePayment() {
        this(null, null);
    }

    public NoteAttachmentSchedulePayment(Integer attachmentId) {
        this(attachmentId, null);
    }

    public NoteAttachmentSchedulePayment(Integer attachmentId, String description) {
     ...
     *
     */
    public static BunqResponse<NoteAttachmentSchedulePayment> delete(Integer schedulePaymentId, Integer noteAttachmentSchedulePaymentId, Integer monetaryAccountId, Map<String, String> customHeaders) {
        ApiClient apiClient = new ApiClient(getApiContext());
    ...
    public static BunqResponse<NoteAttachmentSchedulePayment> delete(Integer schedulePaymentId) {
        return delete(schedulePaymentId, null, null, null);
    }

    public static BunqResponse<NoteAttachmentSchedulePayment> delete(Integer schedulePaymentId, Integer noteAttachmentSchedulePaymentId) {
        return delete(schedulePaymentId, noteAttachmentSchedulePaymentId, null, null);
    }

    public static BunqResponse<NoteAttachmentSchedulePayment> delete(Integer schedulePaymentId, Integer noteAttachmentSchedulePaymentId, Integer monetaryAccountId) {
     ...
     */
    public static BunqResponse<List<NoteAttachmentSchedulePayment>> list(Integer schedulePaymentId, Integer monetaryAccountId, Map<String, String> params, Map<String, String> customHeaders) {
        ApiClient apiClient = new ApiClient(getApiContext());
        ...
        return fromJsonList(NoteAttachmentSchedulePayment.class, responseRaw, OBJECT_TYPE_GET);
    }

    public static BunqResponse<List<NoteAttachmentSchedulePayment>> list() {
        return list(null, null, null, null);
    }

    public static BunqResponse<List<NoteAttachmentSchedulePayment>> list(Integer schedulePaymentId) {
        return list(schedulePaymentId, null, null, null);
    }

    public static BunqResponse<List<NoteAttachmentSchedulePayment>> list(Integer schedulePaymentId, Integer monetaryAccountId) {
        return list(schedulePaymentId, monetaryAccountId, null, null);
    }

    public static BunqResponse<List<NoteAttachmentSchedulePayment>> list(Integer schedulePaymentId, Integer monetaryAccountId, Map<String, String> params) {
     ...
     *
     */
    public static BunqResponse<NoteAttachmentSchedulePayment> get(Integer schedulePaymentId, Integer noteAttachmentSchedulePaymentId, Integer monetaryAccountId, Map<String, String> params, Map<String, String> customHeaders) {
        ApiClient apiClient = new ApiClient(getApiContext());
        ...
        return fromJson(NoteAttachmentSchedulePayment.class, responseRaw, OBJECT_TYPE_GET);
    }

    public static BunqResponse<NoteAttachmentSchedulePayment> get() {
        return get(null, null, null, null, null);
    }

    public static BunqResponse<NoteAttachmentSchedulePayment> get(Integer schedulePaymentId) {
        return get(schedulePaymentId, null, null, null, null);
    }

    public static BunqResponse<NoteAttachmentSchedulePayment> get(Integer schedulePaymentId, Integer noteAttachmentSchedulePaymentId) {
        return get(schedulePaymentId, noteAttachmentSchedulePaymentId, null, null, null);
    }

    public static BunqResponse<NoteAttachmentSchedulePayment> get(Integer schedulePaymentId, Integer noteAttachmentSchedulePaymentId, Integer monetaryAccountId) {
        return get(schedulePaymentId, noteAttachmentSchedulePaymentId, monetaryAccountId, null, null);
    }

    public static BunqResponse<NoteAttachmentSchedulePayment> get(Integer schedulePaymentId, Integer noteAttachmentSchedulePaymentId, Integer monetaryAccountId, Map<String, String> params) {
     ...
     *
     */
    public static NoteAttachmentSchedulePayment fromJsonReader(JsonReader reader) {
        return fromJsonReader(NoteAttachmentSchedulePayment.class, reader);
    }
