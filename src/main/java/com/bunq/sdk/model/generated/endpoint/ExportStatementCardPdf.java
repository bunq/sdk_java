 ...
 */
public class ExportStatementCardPdf extends BunqModel {
  ...
  public ExportStatementCardPdf() {
  this(null, null);
  }

  public ExportStatementCardPdf(String dateStart) {
  this(dateStart, null);
  }

  public ExportStatementCardPdf(String dateStart, String dateEnd) {
...
requestMap.put(FIELD_DATE_END, dateEnd);
  ...
  /**
   */
  public static BunqResponse<ExportStatementCardPdf> get(Integer cardId, Integer exportStatementCardPdfId, Map<String, String> params, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
    ...
    return fromJson(ExportStatementCardPdf.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<ExportStatementCardPdf> get() {
    return get(null, null, null, null);
  }

  public static BunqResponse<ExportStatementCardPdf> get(Integer cardId) {
    return get(cardId, null, null, null);
  }

  public static BunqResponse<ExportStatementCardPdf> get(Integer cardId, Integer exportStatementCardPdfId) {
    return get(cardId, exportStatementCardPdfId, null, null);
  }

  public static BunqResponse<ExportStatementCardPdf> get(Integer cardId, Integer exportStatementCardPdfId, Map<String, String> params) {
    return get(cardId, exportStatementCardPdfId, params, null);
  }

  /**
   */
  public static BunqResponse<List<ExportStatementCardPdf>> list(Integer cardId, Map<String, String> params, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
    BunqResponseRaw responseRaw = apiClient.get(String.format(ENDPOINT_URL_LISTING, determineUserId(), cardId), params, customHeaders);

    return fromJsonList(ExportStatementCardPdf.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<List<ExportStatementCardPdf>> list() {
    return list(null, null, null);
  }

  public static BunqResponse<List<ExportStatementCardPdf>> list(Integer cardId) {
    return list(cardId, null, null);
  }

  public static BunqResponse<List<ExportStatementCardPdf>> list(Integer cardId, Map<String, String> params) {
    return list(cardId, params, null);
  }

  /**
   */
  public static BunqResponse<ExportStatementCardPdf> delete(Integer cardId, Integer exportStatementCardPdfId, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
  ...
  public static BunqResponse<ExportStatementCardPdf> delete(Integer cardId) {
    return delete(cardId, null, null);
  }

  public static BunqResponse<ExportStatementCardPdf> delete(Integer cardId, Integer exportStatementCardPdfId) {
  ...
  /**
   */
  public static ExportStatementCardPdf fromJsonReader(JsonReader reader) {
    return fromJsonReader(ExportStatementCardPdf.class, reader);
  }
