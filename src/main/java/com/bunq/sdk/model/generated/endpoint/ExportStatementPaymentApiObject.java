 ...
 */
public class ExportStatementPaymentApiObject extends BunqModel {
  ...
  public static BunqResponse<ExportStatementPaymentApiObject> get(Integer eventId, Integer exportStatementPaymentId, Integer monetaryAccountId, Map<String, String> params, Map<String, String> customHeaders) {
    ...
    return fromJson(ExportStatementPaymentApiObject.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<ExportStatementPaymentApiObject> get() {
  ...
  /**
   */
  public static ExportStatementPaymentApiObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(ExportStatementPaymentApiObject.class, reader);
  }
