 ...
 */
public class EventApiObject extends BunqModel {
  ...
  private EventObjectObject objectDataAtEvent;
  ...
  public static BunqResponse<EventApiObject> get(Integer eventId, Map<String, String> params, Map<String, String> customHeaders) {
    ...
    return fromJson(EventApiObject.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<EventApiObject> get() {
   ...
   * connect invites).
   */
  public static BunqResponse<List<EventApiObject>> list(Map<String, String> params, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
    BunqResponseRaw responseRaw = apiClient.get(String.format(ENDPOINT_URL_LISTING, determineUserId()), params, customHeaders);

    return fromJsonList(EventApiObject.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<List<EventApiObject>> list() {
    return list(null, null);
  }

  public static BunqResponse<List<EventApiObject>> list(Map<String, String> params) {
   ...
   * the event.
   */
  public EventObjectObject getObjectDataAtEvent() {
    return this.objectDataAtEvent;
  }

  public void setObjectDataAtEvent(EventObjectObject objectDataAtEvent) {
  ...
  /**
   */
  public static EventApiObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(EventApiObject.class, reader);
  }
