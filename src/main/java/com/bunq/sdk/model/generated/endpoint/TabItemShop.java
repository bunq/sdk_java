...
import com.bunq.sdk.model.generated.object.TabAttachment;
...
public class TabItemShop extends BunqModel {
  ...
  public TabItemShop(String description, String eanCode, String avatarAttachmentUuid, List<TabAttachment> tabAttachment) {
  this(description, eanCode, avatarAttachmentUuid, tabAttachment, null, null);
  }

  public TabItemShop(String description, String eanCode, String avatarAttachmentUuid, List<TabAttachment> tabAttachment, String quantity) {
  this(description, eanCode, avatarAttachmentUuid, tabAttachment, quantity, null);
  }

  public TabItemShop(String description, String eanCode, String avatarAttachmentUuid, List<TabAttachment> tabAttachment, String quantity, Amount amount) {
   ...
   * Tab.
   */
  public static BunqResponse<Integer> create(Integer cashRegisterId, String tabUuid, String description, Integer monetaryAccountId, String eanCode, String avatarAttachmentUuid, List<TabAttachment> tabAttachment, String quantity, Amount amount, Map<String, String> customHeaders) {
...
requestMap.put(FIELD_AMOUNT, amount);
  ...
  public static BunqResponse<Integer> create(Integer cashRegisterId, String tabUuid, String description, Integer monetaryAccountId, String eanCode, String avatarAttachmentUuid, List<TabAttachment> tabAttachment) {
  ...
  public static BunqResponse<Integer> create(Integer cashRegisterId, String tabUuid, String description, Integer monetaryAccountId, String eanCode, String avatarAttachmentUuid, List<TabAttachment> tabAttachment, String quantity) {
  ...
  public static BunqResponse<Integer> create(Integer cashRegisterId, String tabUuid, String description, Integer monetaryAccountId, String eanCode, String avatarAttachmentUuid, List<TabAttachment> tabAttachment, String quantity, Amount amount) {
   ...
   * Tab.
   */
  public static BunqResponse<Integer> update(Integer cashRegisterId, String tabUuid, Integer tabItemShopId, Integer monetaryAccountId, String description, String eanCode, String avatarAttachmentUuid, List<TabAttachment> tabAttachment, String quantity, Amount amount, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
...
requestMap.put(FIELD_AMOUNT, amount);
  ...
  public static BunqResponse<Integer> update(Integer cashRegisterId, String tabUuid, Integer tabItemShopId, Integer monetaryAccountId, String description, String eanCode, String avatarAttachmentUuid, List<TabAttachment> tabAttachment) {
  ...
  public static BunqResponse<Integer> update(Integer cashRegisterId, String tabUuid, Integer tabItemShopId, Integer monetaryAccountId, String description, String eanCode, String avatarAttachmentUuid, List<TabAttachment> tabAttachment, String quantity) {
  ...
  public static BunqResponse<Integer> update(Integer cashRegisterId, String tabUuid, Integer tabItemShopId, Integer monetaryAccountId, String description, String eanCode, String avatarAttachmentUuid, List<TabAttachment> tabAttachment, String quantity, Amount amount) {
