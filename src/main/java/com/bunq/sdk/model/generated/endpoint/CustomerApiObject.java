 ...
 */
public class CustomerApiObject extends BunqModel {
  ...
  public CustomerApiObject() {
  this(null, null);
  }

  public CustomerApiObject(String billingAccountId) {
  this(billingAccountId, null);
  }

  public CustomerApiObject(String billingAccountId, String invoiceNotificationPreference) {
  ...
  /**
   */
  public static CustomerApiObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(CustomerApiObject.class, reader);
  }
