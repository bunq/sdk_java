 ...
 */
public class TransferwiseQuoteTemporaryApiObject extends BunqModel {
  ...
  public TransferwiseQuoteTemporaryApiObject() {
  this(null, null, null, null);
  }

  public TransferwiseQuoteTemporaryApiObject(String currencySource) {
  this(currencySource, null, null, null);
  }

  public TransferwiseQuoteTemporaryApiObject(String currencySource, String currencyTarget) {
  this(currencySource, currencyTarget, null, null);
  }

  public TransferwiseQuoteTemporaryApiObject(String currencySource, String currencyTarget, AmountObject amountSource) {
  this(currencySource, currencyTarget, amountSource, null);
  }

  public TransferwiseQuoteTemporaryApiObject(String currencySource, String currencyTarget, AmountObject amountSource, AmountObject amountTarget) {
...
requestMap.put(FIELD_AMOUNT_TARGET, amountTarget);
  ...
  public static BunqResponse<TransferwiseQuoteTemporaryApiObject> get(Integer transferwiseQuoteTemporaryId, Map<String, String> params, Map<String, String> customHeaders) {
    ...
    return fromJson(TransferwiseQuoteTemporaryApiObject.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<TransferwiseQuoteTemporaryApiObject> get() {
  ...
  /**
   */
  public static TransferwiseQuoteTemporaryApiObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(TransferwiseQuoteTemporaryApiObject.class, reader);
  }
