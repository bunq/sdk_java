 ...
 */
public class ExportAnnualOverviewContentApiObject extends BunqModel {
  ...
  /**
   */
  public static ExportAnnualOverviewContentApiObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(ExportAnnualOverviewContentApiObject.class, reader);
  }
