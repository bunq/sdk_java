 ...
 */
public class NotificationFilterUrlMonetaryAccountApiObject extends BunqModel {
  ...
  public NotificationFilterUrlMonetaryAccountApiObject() {
  this(null);
  }

  public NotificationFilterUrlMonetaryAccountApiObject(List<NotificationFilterUrlObject> notificationFilters) {
...
requestMap.put(FIELD_NOTIFICATION_FILTERS, notificationFilters);
  ...
  public static BunqResponse<List<NotificationFilterUrlMonetaryAccountApiObject>> list(Integer monetaryAccountId, Map<String, String> params, Map<String, String> customHeaders) {
    ...
    return fromJsonList(NotificationFilterUrlMonetaryAccountApiObject.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<List<NotificationFilterUrlMonetaryAccountApiObject>> list() {
  ...
  /**
   */
  public static NotificationFilterUrlMonetaryAccountApiObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(NotificationFilterUrlMonetaryAccountApiObject.class, reader);
  }
