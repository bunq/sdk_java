 ...
 */
public class PaymentApiObject extends BunqModel {
  ...
  public PaymentApiObject(AmountObject amount) {
  this(amount, null, null, null, null, null);
  }

  public PaymentApiObject(AmountObject amount, PointerObject counterpartyAlias) {
  this(amount, counterpartyAlias, null, null, null, null);
  }

  public PaymentApiObject(AmountObject amount, PointerObject counterpartyAlias, String description) {
  this(amount, counterpartyAlias, description, null, null, null);
  }

  public PaymentApiObject(AmountObject amount, PointerObject counterpartyAlias, String description, List<AttachmentMonetaryAccountPaymentObject> attachment) {
  this(amount, counterpartyAlias, description, attachment, null, null);
  }

  public PaymentApiObject(AmountObject amount, PointerObject counterpartyAlias, String description, List<AttachmentMonetaryAccountPaymentObject> attachment, String merchantReference) {
  this(amount, counterpartyAlias, description, attachment, merchantReference, null);
  }

  public PaymentApiObject(AmountObject amount, PointerObject counterpartyAlias, String description, List<AttachmentMonetaryAccountPaymentObject> attachment, String merchantReference, Boolean allowBunqto) {
...
requestMap.put(FIELD_ALLOW_BUNQTO, allowBunqto);
  ...
  public static BunqResponse<PaymentApiObject> get(Integer paymentId, Integer monetaryAccountId, Map<String, String> params, Map<String, String> customHeaders) {
    ...
    return fromJson(PaymentApiObject.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<PaymentApiObject> get() {
  ...
  public static BunqResponse<List<PaymentApiObject>> list(Integer monetaryAccountId, Map<String, String> params, Map<String, String> customHeaders) {
    ...
    return fromJsonList(PaymentApiObject.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<List<PaymentApiObject>> list() {
  ...
  /**
   */
  public static PaymentApiObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(PaymentApiObject.class, reader);
  }
