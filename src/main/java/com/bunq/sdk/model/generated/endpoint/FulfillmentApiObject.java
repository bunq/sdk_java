 ...
 */
public class FulfillmentApiObject extends BunqModel {
  ...
  /**
   */
  public static FulfillmentApiObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(FulfillmentApiObject.class, reader);
  }
