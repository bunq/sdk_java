 ...
 */
public class PaymentAutoAllocateInstanceApiObject extends BunqModel {
  ...
  public static BunqResponse<List<PaymentAutoAllocateInstanceApiObject>> list(Integer paymentAutoAllocateId, Integer monetaryAccountId, Map<String, String> params, Map<String, String> customHeaders) {
    ...
    return fromJsonList(PaymentAutoAllocateInstanceApiObject.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<List<PaymentAutoAllocateInstanceApiObject>> list() {
  ...
  public static BunqResponse<PaymentAutoAllocateInstanceApiObject> get(Integer paymentAutoAllocateId, Integer paymentAutoAllocateInstanceId, Integer monetaryAccountId, Map<String, String> params, Map<String, String> customHeaders) {
    ...
    return fromJson(PaymentAutoAllocateInstanceApiObject.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<PaymentAutoAllocateInstanceApiObject> get() {
   ...
   * All Ginmon transaction orders executed with this instance.
   */
  public List<GinmonTransactionApiObject> getAllGinmonTransactionOrder() {
  ...
  /**
   */
  public static PaymentAutoAllocateInstanceApiObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(PaymentAutoAllocateInstanceApiObject.class, reader);
  }
