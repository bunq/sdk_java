 ...
 */
public class NoteTextSchedulePaymentBatch extends BunqModel {
  ...
  public NoteTextSchedulePaymentBatch() {
    this(null);
  }

  public NoteTextSchedulePaymentBatch(String content) {
  ...
  /**
   */
  public static BunqResponse<NoteTextSchedulePaymentBatch> delete(Integer schedulePaymentBatchId, Integer noteTextSchedulePaymentBatchId, Integer monetaryAccountId, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
  ...
  public static BunqResponse<NoteTextSchedulePaymentBatch> delete(Integer schedulePaymentBatchId) {
    return delete(schedulePaymentBatchId, null, null, null);
  }

  public static BunqResponse<NoteTextSchedulePaymentBatch> delete(Integer schedulePaymentBatchId, Integer noteTextSchedulePaymentBatchId) {
    return delete(schedulePaymentBatchId, noteTextSchedulePaymentBatchId, null, null);
  }

  public static BunqResponse<NoteTextSchedulePaymentBatch> delete(Integer schedulePaymentBatchId, Integer noteTextSchedulePaymentBatchId, Integer monetaryAccountId) {
   ...
   */
  public static BunqResponse<List<NoteTextSchedulePaymentBatch>> list(Integer schedulePaymentBatchId, Integer monetaryAccountId, Map<String, String> params, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
    ...
    return fromJsonList(NoteTextSchedulePaymentBatch.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<List<NoteTextSchedulePaymentBatch>> list() {
    return list(null, null, null, null);
  }

  public static BunqResponse<List<NoteTextSchedulePaymentBatch>> list(Integer schedulePaymentBatchId) {
    return list(schedulePaymentBatchId, null, null, null);
  }

  public static BunqResponse<List<NoteTextSchedulePaymentBatch>> list(Integer schedulePaymentBatchId, Integer monetaryAccountId) {
    return list(schedulePaymentBatchId, monetaryAccountId, null, null);
  }

  public static BunqResponse<List<NoteTextSchedulePaymentBatch>> list(Integer schedulePaymentBatchId, Integer monetaryAccountId, Map<String, String> params) {
    return list(schedulePaymentBatchId, monetaryAccountId, params, null);
  }

  /**
   */
  public static BunqResponse<NoteTextSchedulePaymentBatch> get(Integer schedulePaymentBatchId, Integer noteTextSchedulePaymentBatchId, Integer monetaryAccountId, Map<String, String> params, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
    ...
    return fromJson(NoteTextSchedulePaymentBatch.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<NoteTextSchedulePaymentBatch> get() {
    return get(null, null, null, null, null);
  }

  public static BunqResponse<NoteTextSchedulePaymentBatch> get(Integer schedulePaymentBatchId) {
    return get(schedulePaymentBatchId, null, null, null, null);
  }

  public static BunqResponse<NoteTextSchedulePaymentBatch> get(Integer schedulePaymentBatchId, Integer noteTextSchedulePaymentBatchId) {
    return get(schedulePaymentBatchId, noteTextSchedulePaymentBatchId, null, null, null);
  }

  public static BunqResponse<NoteTextSchedulePaymentBatch> get(Integer schedulePaymentBatchId, Integer noteTextSchedulePaymentBatchId, Integer monetaryAccountId) {
    return get(schedulePaymentBatchId, noteTextSchedulePaymentBatchId, monetaryAccountId, null, null);
  }

  public static BunqResponse<NoteTextSchedulePaymentBatch> get(Integer schedulePaymentBatchId, Integer noteTextSchedulePaymentBatchId, Integer monetaryAccountId, Map<String, String> params) {
  ...
  /**
   */
  public static NoteTextSchedulePaymentBatch fromJsonReader(JsonReader reader) {
    return fromJsonReader(NoteTextSchedulePaymentBatch.class, reader);
  }
