 ...
 */
public class UserCredentialPasswordIpApiObject extends BunqModel {
  ...
  public static BunqResponse<UserCredentialPasswordIpApiObject> get() {
  ...
  /**
   */
  public static BunqResponse<List<UserCredentialPasswordIpApiObject>> list(Map<String, String> params, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
    BunqResponseRaw responseRaw = apiClient.get(String.format(ENDPOINT_URL_LISTING, determineUserId()), params, customHeaders);

    return fromJsonList(UserCredentialPasswordIpApiObject.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<List<UserCredentialPasswordIpApiObject>> list() {
    return list(null, null);
  }

  public static BunqResponse<List<UserCredentialPasswordIpApiObject>> list(Map<String, String> params) {
  ...
  /**
   */
  public static UserCredentialPasswordIpApiObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(UserCredentialPasswordIpApiObject.class, reader);
  }
