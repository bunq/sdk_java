...
public class NoteAttachmentScheduleInstance extends BunqModel {
  ...
  /**
   */
  public static BunqResponse<NoteAttachmentScheduleInstance> delete(Integer scheduleId, Integer scheduleInstanceId, Integer noteAttachmentScheduleInstanceId, Integer monetaryAccountId, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
  ...
  public static BunqResponse<NoteAttachmentScheduleInstance> delete(Integer scheduleId) {
    return delete(scheduleId, null, null, null, null);
  }

  public static BunqResponse<NoteAttachmentScheduleInstance> delete(Integer scheduleId, Integer scheduleInstanceId) {
    return delete(scheduleId, scheduleInstanceId, null, null, null);
  }

  public static BunqResponse<NoteAttachmentScheduleInstance> delete(Integer scheduleId, Integer scheduleInstanceId, Integer noteAttachmentScheduleInstanceId) {
    return delete(scheduleId, scheduleInstanceId, noteAttachmentScheduleInstanceId, null, null);
  }

  public static BunqResponse<NoteAttachmentScheduleInstance> delete(Integer scheduleId, Integer scheduleInstanceId, Integer noteAttachmentScheduleInstanceId, Integer monetaryAccountId) {
   ...
   */
  public static BunqResponse<List<NoteAttachmentScheduleInstance>> list(Integer scheduleId, Integer scheduleInstanceId, Integer monetaryAccountId, Map<String, String> params, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
    ...
    return fromJsonList(NoteAttachmentScheduleInstance.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<List<NoteAttachmentScheduleInstance>> list() {
    return list(null, null, null, null, null);
  }

  public static BunqResponse<List<NoteAttachmentScheduleInstance>> list(Integer scheduleId) {
    return list(scheduleId, null, null, null, null);
  }

  public static BunqResponse<List<NoteAttachmentScheduleInstance>> list(Integer scheduleId, Integer scheduleInstanceId) {
    return list(scheduleId, scheduleInstanceId, null, null, null);
  }

  public static BunqResponse<List<NoteAttachmentScheduleInstance>> list(Integer scheduleId, Integer scheduleInstanceId, Integer monetaryAccountId) {
    return list(scheduleId, scheduleInstanceId, monetaryAccountId, null, null);
  }

  public static BunqResponse<List<NoteAttachmentScheduleInstance>> list(Integer scheduleId, Integer scheduleInstanceId, Integer monetaryAccountId, Map<String, String> params) {
    return list(scheduleId, scheduleInstanceId, monetaryAccountId, params, null);
  }

  /**
   */
  public static BunqResponse<NoteAttachmentScheduleInstance> get(Integer scheduleId, Integer scheduleInstanceId, Integer noteAttachmentScheduleInstanceId, Integer monetaryAccountId, Map<String, String> params, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
    ...
    return fromJson(NoteAttachmentScheduleInstance.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<NoteAttachmentScheduleInstance> get() {
    return get(null, null, null, null, null, null);
  }

  public static BunqResponse<NoteAttachmentScheduleInstance> get(Integer scheduleId) {
    return get(scheduleId, null, null, null, null, null);
  }

  public static BunqResponse<NoteAttachmentScheduleInstance> get(Integer scheduleId, Integer scheduleInstanceId) {
    return get(scheduleId, scheduleInstanceId, null, null, null, null);
  }

  public static BunqResponse<NoteAttachmentScheduleInstance> get(Integer scheduleId, Integer scheduleInstanceId, Integer noteAttachmentScheduleInstanceId) {
    return get(scheduleId, scheduleInstanceId, noteAttachmentScheduleInstanceId, null, null, null);
  }

  public static BunqResponse<NoteAttachmentScheduleInstance> get(Integer scheduleId, Integer scheduleInstanceId, Integer noteAttachmentScheduleInstanceId, Integer monetaryAccountId) {
    return get(scheduleId, scheduleInstanceId, noteAttachmentScheduleInstanceId, monetaryAccountId, null, null);
  }

  public static BunqResponse<NoteAttachmentScheduleInstance> get(Integer scheduleId, Integer scheduleInstanceId, Integer noteAttachmentScheduleInstanceId, Integer monetaryAccountId, Map<String, String> params) {
