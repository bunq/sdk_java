 ...
 */
public class PaymentAutoAllocateApiObject extends BunqModel {
  ...
  private AmountObject triggerAmount;
  ...
  private PaymentApiObject paymentOriginal;
  ...
  private PaymentApiObject paymentLatest;
  ...
  private List<PaymentAutoAllocateDefinitionApiObject> definitionFieldForRequest;

  public PaymentAutoAllocateApiObject() {
  this(null, null, null);
  }
...
requestMap.put(FIELD_DEFINITION, definition);
  ...
  public static BunqResponse<PaymentAutoAllocateApiObject> get(Integer paymentAutoAllocateId, Integer monetaryAccountId, Map<String, String> params, Map<String, String> customHeaders) {
    ...
    return fromJson(PaymentAutoAllocateApiObject.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<PaymentAutoAllocateApiObject> get() {
  ...
  public static BunqResponse<List<PaymentAutoAllocateApiObject>> list(Integer monetaryAccountId, Map<String, String> params, Map<String, String> customHeaders) {
    ...
    return fromJsonList(PaymentAutoAllocateApiObject.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<List<PaymentAutoAllocateApiObject>> list() {
...
requestMap.put(FIELD_DEFINITION, definition);
   ...
   * The amount on which this payment auto allocate will be triggered.
   */
  public AmountObject getTriggerAmount() {
    return this.triggerAmount;
  }

  public void setTriggerAmount(AmountObject triggerAmount) {
   ...
   * The payment that was used to define the triggers for this payment auto allocate.
   */
  public PaymentApiObject getPaymentOriginal() {
    return this.paymentOriginal;
  }

  public void setPaymentOriginal(PaymentApiObject paymentOriginal) {
   ...
   * The latest payment allocated using this payment auto allocate.
   */
  public PaymentApiObject getPaymentLatest() {
    return this.paymentLatest;
  }

  public void setPaymentLatest(PaymentApiObject paymentLatest) {
  ...
  /**
   */
  public static PaymentAutoAllocateApiObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(PaymentAutoAllocateApiObject.class, reader);
  }
