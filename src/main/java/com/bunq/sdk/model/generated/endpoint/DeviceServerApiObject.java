 ...
 */
public class DeviceServerApiObject extends BunqModel {
  ...
  public DeviceServerApiObject() {
  this(null, null, null);
  }

  public DeviceServerApiObject(String description) {
  this(description, null, null);
  }

  public DeviceServerApiObject(String description, String secret) {
  this(description, secret, null);
  }

  public DeviceServerApiObject(String description, String secret, List<String> permittedIps) {
...
requestMap.put(FIELD_PERMITTED_IPS, permittedIps);
  ...
  public static BunqResponse<DeviceServerApiObject> get(Integer deviceServerId, Map<String, String> params, Map<String, String> customHeaders) {
    ...
    return fromJson(DeviceServerApiObject.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<DeviceServerApiObject> get() {
   ...
   */
  public static BunqResponse<List<DeviceServerApiObject>> list(Map<String, String> params, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
    BunqResponseRaw responseRaw = apiClient.get(ENDPOINT_URL_LISTING, params, customHeaders);

    return fromJsonList(DeviceServerApiObject.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<List<DeviceServerApiObject>> list() {
    return list(null, null);
  }

  public static BunqResponse<List<DeviceServerApiObject>> list(Map<String, String> params) {
  ...
  /**
   */
  public static DeviceServerApiObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(DeviceServerApiObject.class, reader);
  }
