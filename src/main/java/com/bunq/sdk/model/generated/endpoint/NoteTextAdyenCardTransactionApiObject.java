 ...
 */
public class NoteTextAdyenCardTransactionApiObject extends BunqModel {
  ...
  public NoteTextAdyenCardTransactionApiObject() {
  this(null);
  }

  public NoteTextAdyenCardTransactionApiObject(String content) {
    this.contentFieldForRequest = content;
  }  /**
   * @param content The content of the note.
   */
  public static BunqResponse<Long> create(Integer adyenCardTransactionId, Integer monetaryAccountId, String content, Map<String, String> customHeaders) {
...
requestMap.put(FIELD_CONTENT, content);
  ...
  public static BunqResponse<Long> create(Integer adyenCardTransactionId) {
    return create(adyenCardTransactionId, null, null, null);
  }

  public static BunqResponse<Long> create(Integer adyenCardTransactionId, Integer monetaryAccountId) {
    return create(adyenCardTransactionId, monetaryAccountId, null, null);
  }

  public static BunqResponse<Long> create(Integer adyenCardTransactionId, Integer monetaryAccountId, String content) {
   ...
   * @param content The content of the note.
   */
  public static BunqResponse<Long> update(Integer adyenCardTransactionId, Integer noteTextAdyenCardTransactionId, Integer monetaryAccountId, String content, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
...
requestMap.put(FIELD_CONTENT, content);
  ...
  public static BunqResponse<Long> update(Integer adyenCardTransactionId) {
    return update(adyenCardTransactionId, null, null, null, null);
  }

  public static BunqResponse<Long> update(Integer adyenCardTransactionId, Integer noteTextAdyenCardTransactionId) {
    return update(adyenCardTransactionId, noteTextAdyenCardTransactionId, null, null, null);
  }

  public static BunqResponse<Long> update(Integer adyenCardTransactionId, Integer noteTextAdyenCardTransactionId, Integer monetaryAccountId) {
    return update(adyenCardTransactionId, noteTextAdyenCardTransactionId, monetaryAccountId, null, null);
  }

  public static BunqResponse<Long> update(Integer adyenCardTransactionId, Integer noteTextAdyenCardTransactionId, Integer monetaryAccountId, String content) {
  ...
  public static BunqResponse<List<NoteTextAdyenCardTransactionApiObject>> list(Integer adyenCardTransactionId, Integer monetaryAccountId, Map<String, String> params, Map<String, String> customHeaders) {
    ...
    return fromJsonList(NoteTextAdyenCardTransactionApiObject.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<List<NoteTextAdyenCardTransactionApiObject>> list() {
  ...
  public static BunqResponse<NoteTextAdyenCardTransactionApiObject> get(Integer adyenCardTransactionId, Integer noteTextAdyenCardTransactionId, Integer monetaryAccountId, Map<String, String> params, Map<String, String> customHeaders) {
    ...
    return fromJson(NoteTextAdyenCardTransactionApiObject.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<NoteTextAdyenCardTransactionApiObject> get() {
  ...
  /**
   */
  public static NoteTextAdyenCardTransactionApiObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(NoteTextAdyenCardTransactionApiObject.class, reader);
  }
