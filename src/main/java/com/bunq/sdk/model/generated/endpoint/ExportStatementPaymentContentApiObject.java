 ...
 */
public class ExportStatementPaymentContentApiObject extends BunqModel {
  ...
  /**
   */
  public static ExportStatementPaymentContentApiObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(ExportStatementPaymentContentApiObject.class, reader);
  }
