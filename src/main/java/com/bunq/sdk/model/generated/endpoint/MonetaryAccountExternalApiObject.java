...
public class MonetaryAccountExternalApiObject extends BunqModel {
   ...
   */
  public static BunqResponse<Long> create(String currency, String service, String description, AmountObject dailyLimit, String avatarUuid, String status, String subStatus, String reason, String reasonDescription, String displayName, MonetaryAccountSettingObject setting, Map<String, String> customHeaders) {
...
requestMap.put(FIELD_SETTING, setting);
  ...
  /**
   */
  public static BunqResponse<MonetaryAccountExternalApiObject> get(Long monetaryAccountExternalId, Map<String, String> params, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
  ...
  public static BunqResponse<MonetaryAccountExternalApiObject> get(Long monetaryAccountExternalId) {
    return get(monetaryAccountExternalId, null, null);
  }

  public static BunqResponse<MonetaryAccountExternalApiObject> get(Long monetaryAccountExternalId, Map<String, String> params) {
   ...
   * @param setting The settings of the MonetaryAccountExternal.
   */
  public static BunqResponse<Long> update(Long monetaryAccountExternalId, String description, AmountObject dailyLimit, String avatarUuid, String status, String subStatus, String reason, String reasonDescription, String displayName, MonetaryAccountSettingObject setting, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
...
requestMap.put(FIELD_SETTING, setting);
  ...
  public static BunqResponse<Long> update(Long monetaryAccountExternalId) {
    return update(monetaryAccountExternalId, null, null, null, null, null, null, null, null, null, null);
  }

  public static BunqResponse<Long> update(Long monetaryAccountExternalId, String description) {
    return update(monetaryAccountExternalId, description, null, null, null, null, null, null, null, null, null);
  }

  public static BunqResponse<Long> update(Long monetaryAccountExternalId, String description, AmountObject dailyLimit) {
    return update(monetaryAccountExternalId, description, dailyLimit, null, null, null, null, null, null, null, null);
  }

  public static BunqResponse<Long> update(Long monetaryAccountExternalId, String description, AmountObject dailyLimit, String avatarUuid) {
    return update(monetaryAccountExternalId, description, dailyLimit, avatarUuid, null, null, null, null, null, null, null);
  }

  public static BunqResponse<Long> update(Long monetaryAccountExternalId, String description, AmountObject dailyLimit, String avatarUuid, String status) {
    return update(monetaryAccountExternalId, description, dailyLimit, avatarUuid, status, null, null, null, null, null, null);
  }

  public static BunqResponse<Long> update(Long monetaryAccountExternalId, String description, AmountObject dailyLimit, String avatarUuid, String status, String subStatus) {
    return update(monetaryAccountExternalId, description, dailyLimit, avatarUuid, status, subStatus, null, null, null, null, null);
  }

  public static BunqResponse<Long> update(Long monetaryAccountExternalId, String description, AmountObject dailyLimit, String avatarUuid, String status, String subStatus, String reason) {
    return update(monetaryAccountExternalId, description, dailyLimit, avatarUuid, status, subStatus, reason, null, null, null, null);
  }

  public static BunqResponse<Long> update(Long monetaryAccountExternalId, String description, AmountObject dailyLimit, String avatarUuid, String status, String subStatus, String reason, String reasonDescription) {
  ...
  public static BunqResponse<Long> update(Long monetaryAccountExternalId, String description, AmountObject dailyLimit, String avatarUuid, String status, String subStatus, String reason, String reasonDescription, String displayName) {
  ...
  public static BunqResponse<Long> update(Long monetaryAccountExternalId, String description, AmountObject dailyLimit, String avatarUuid, String status, String subStatus, String reason, String reasonDescription, String displayName, MonetaryAccountSettingObject setting) {
