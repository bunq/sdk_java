...
requestMap.put(FIELD_SETTING, setting);
   ...
   * @param setting The settings of the MonetaryAccountExternal.
   */
  public static BunqResponse<Long> update(Integer monetaryAccountExternalId, String description, AmountObject dailyLimit, String avatarUuid, String status, String subStatus, String reason, String reasonDescription, String displayName, MonetaryAccountSettingObject setting, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
...
requestMap.put(FIELD_SETTING, setting);
  ...
  public static BunqResponse<Long> update(Integer monetaryAccountExternalId) {
    return update(monetaryAccountExternalId, null, null, null, null, null, null, null, null, null, null);
  }

  public static BunqResponse<Long> update(Integer monetaryAccountExternalId, String description) {
    return update(monetaryAccountExternalId, description, null, null, null, null, null, null, null, null, null);
  }

  public static BunqResponse<Long> update(Integer monetaryAccountExternalId, String description, AmountObject dailyLimit) {
    return update(monetaryAccountExternalId, description, dailyLimit, null, null, null, null, null, null, null, null);
  }

  public static BunqResponse<Long> update(Integer monetaryAccountExternalId, String description, AmountObject dailyLimit, String avatarUuid) {
    return update(monetaryAccountExternalId, description, dailyLimit, avatarUuid, null, null, null, null, null, null, null);
  }

  public static BunqResponse<Long> update(Integer monetaryAccountExternalId, String description, AmountObject dailyLimit, String avatarUuid, String status) {
    return update(monetaryAccountExternalId, description, dailyLimit, avatarUuid, status, null, null, null, null, null, null);
  }

  public static BunqResponse<Long> update(Integer monetaryAccountExternalId, String description, AmountObject dailyLimit, String avatarUuid, String status, String subStatus) {
    return update(monetaryAccountExternalId, description, dailyLimit, avatarUuid, status, subStatus, null, null, null, null, null);
  }

  public static BunqResponse<Long> update(Integer monetaryAccountExternalId, String description, AmountObject dailyLimit, String avatarUuid, String status, String subStatus, String reason) {
    return update(monetaryAccountExternalId, description, dailyLimit, avatarUuid, status, subStatus, reason, null, null, null, null);
  }

  public static BunqResponse<Long> update(Integer monetaryAccountExternalId, String description, AmountObject dailyLimit, String avatarUuid, String status, String subStatus, String reason, String reasonDescription) {
  ...
  public static BunqResponse<Long> update(Integer monetaryAccountExternalId, String description, AmountObject dailyLimit, String avatarUuid, String status, String subStatus, String reason, String reasonDescription, String displayName) {
  ...
  public static BunqResponse<Long> update(Integer monetaryAccountExternalId, String description, AmountObject dailyLimit, String avatarUuid, String status, String subStatus, String reason, String reasonDescription, String displayName, MonetaryAccountSettingObject setting) {
