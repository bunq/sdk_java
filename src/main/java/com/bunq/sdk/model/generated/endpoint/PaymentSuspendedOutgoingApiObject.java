 ...
 */
public class PaymentSuspendedOutgoingApiObject extends BunqModel {
  ...
  public PaymentSuspendedOutgoingApiObject() {
  this(null);
  }

  public PaymentSuspendedOutgoingApiObject(String status) {
  ...
  /**
   */
  public static PaymentSuspendedOutgoingApiObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(PaymentSuspendedOutgoingApiObject.class, reader);
  }
