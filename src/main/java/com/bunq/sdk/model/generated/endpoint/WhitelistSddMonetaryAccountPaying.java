 ...
 */
public class WhitelistSddMonetaryAccountPaying extends BunqModel {
   ...
   */
  public static BunqResponse<WhitelistSddMonetaryAccountPaying> get(Integer whitelistSddMonetaryAccountPayingId, Integer monetaryAccountId, Map<String, String> params, Map<String, String> customHeaders) {
    ...
    return fromJson(WhitelistSddMonetaryAccountPaying.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<WhitelistSddMonetaryAccountPaying> get() {
    return get(null, null, null, null);
  }

  public static BunqResponse<WhitelistSddMonetaryAccountPaying> get(Integer whitelistSddMonetaryAccountPayingId) {
    return get(whitelistSddMonetaryAccountPayingId, null, null, null);
  }

  public static BunqResponse<WhitelistSddMonetaryAccountPaying> get(Integer whitelistSddMonetaryAccountPayingId, Integer monetaryAccountId) {
    return get(whitelistSddMonetaryAccountPayingId, monetaryAccountId, null, null);
  }

  public static BunqResponse<WhitelistSddMonetaryAccountPaying> get(Integer whitelistSddMonetaryAccountPayingId, Integer monetaryAccountId, Map<String, String> params) {
   ...
   */
  public static BunqResponse<List<WhitelistSddMonetaryAccountPaying>> list(Integer monetaryAccountId, Map<String, String> params, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
    BunqResponseRaw responseRaw = apiClient.get(String.format(ENDPOINT_URL_LISTING, determineUserId(), determineMonetaryAccountId(monetaryAccountId)), params, customHeaders);

    return fromJsonList(WhitelistSddMonetaryAccountPaying.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<List<WhitelistSddMonetaryAccountPaying>> list() {
    return list(null, null, null);
  }

  public static BunqResponse<List<WhitelistSddMonetaryAccountPaying>> list(Integer monetaryAccountId) {
    return list(monetaryAccountId, null, null);
  }

  public static BunqResponse<List<WhitelistSddMonetaryAccountPaying>> list(Integer monetaryAccountId, Map<String, String> params) {
  ...
  /**
   */
  public static WhitelistSddMonetaryAccountPaying fromJsonReader(JsonReader reader) {
    return fromJsonReader(WhitelistSddMonetaryAccountPaying.class, reader);
  }
