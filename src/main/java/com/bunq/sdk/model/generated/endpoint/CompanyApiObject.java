...
import com.bunq.sdk.model.generated.object.CompanyVatNumberObject;
 ...
 */
public class CompanyApiObject extends BunqModel {
  ...
  private CompanyVatNumberObject vatNumberFieldForRequest;
  ...
  private List<CompanyVatNumberObject> vatNumbersFieldForRequest;
  ...
  public CompanyApiObject() {
  this(null, null, null, null, null, null, null, null, null, null, null, null);
  }

  public CompanyApiObject(String name) {
  this(name, null, null, null, null, null, null, null, null, null, null, null);
  }

  public CompanyApiObject(String name, AddressObject addressMain) {
  this(name, addressMain, null, null, null, null, null, null, null, null, null, null);
  }

  public CompanyApiObject(String name, AddressObject addressMain, AddressObject addressPostal) {
  this(name, addressMain, addressPostal, null, null, null, null, null, null, null, null, null);
  }

  public CompanyApiObject(String name, AddressObject addressMain, AddressObject addressPostal, String country) {
  this(name, addressMain, addressPostal, country, null, null, null, null, null, null, null, null);
  }

  public CompanyApiObject(String name, AddressObject addressMain, AddressObject addressPostal, String country, String legalForm) {
  this(name, addressMain, addressPostal, country, legalForm, null, null, null, null, null, null, null);
  }

  public CompanyApiObject(String name, AddressObject addressMain, AddressObject addressPostal, String country, String legalForm, String subscriptionType) {
  this(name, addressMain, addressPostal, country, legalForm, subscriptionType, null, null, null, null, null, null);
  }

  public CompanyApiObject(String name, AddressObject addressMain, AddressObject addressPostal, String country, String legalForm, String subscriptionType, List<UboObject> ubo) {
  this(name, addressMain, addressPostal, country, legalForm, subscriptionType, ubo, null, null, null, null, null);
  }

  public CompanyApiObject(String name, AddressObject addressMain, AddressObject addressPostal, String country, String legalForm, String subscriptionType, List<UboObject> ubo, String chamberOfCommerceNumber) {
  this(name, addressMain, addressPostal, country, legalForm, subscriptionType, ubo, chamberOfCommerceNumber, null, null, null, null);
  }

  public CompanyApiObject(String name, AddressObject addressMain, AddressObject addressPostal, String country, String legalForm, String subscriptionType, List<UboObject> ubo, String chamberOfCommerceNumber, String avatarUuid) {
  ...
  public CompanyApiObject(String name, AddressObject addressMain, AddressObject addressPostal, String country, String legalForm, String subscriptionType, List<UboObject> ubo, String chamberOfCommerceNumber, String avatarUuid, CompanyVatNumberObject vatNumber) {
  ...
  public CompanyApiObject(String name, AddressObject addressMain, AddressObject addressPostal, String country, String legalForm, String subscriptionType, List<UboObject> ubo, String chamberOfCommerceNumber, String avatarUuid, CompanyVatNumberObject vatNumber, List<CompanyVatNumberObject> vatNumbers) {
  ...
  public CompanyApiObject(String name, AddressObject addressMain, AddressObject addressPostal, String country, String legalForm, String subscriptionType, List<UboObject> ubo, String chamberOfCommerceNumber, String avatarUuid, CompanyVatNumberObject vatNumber, List<CompanyVatNumberObject> vatNumbers, String signupTrackType) {
   ...
   */
  public static BunqResponse<Long> create(String name, AddressObject addressMain, AddressObject addressPostal, String country, String legalForm, String subscriptionType, List<UboObject> ubo, String chamberOfCommerceNumber, String avatarUuid, CompanyVatNumberObject vatNumber, List<CompanyVatNumberObject> vatNumbers, String signupTrackType, Map<String, String> customHeaders) {
...
requestMap.put(FIELD_SIGNUP_TRACK_TYPE, signupTrackType);
  ...
  public static BunqResponse<Long> create(String name, AddressObject addressMain) {
  ...
  public static BunqResponse<Long> create(String name, AddressObject addressMain, AddressObject addressPostal, String country) {
    return create(name, addressMain, addressPostal, country, null, null, null, null, null, null, null, null, null);
  }

  public static BunqResponse<Long> create(String name, AddressObject addressMain, AddressObject addressPostal, String country, String legalForm) {
    return create(name, addressMain, addressPostal, country, legalForm, null, null, null, null, null, null, null, null);
  }

  public static BunqResponse<Long> create(String name, AddressObject addressMain, AddressObject addressPostal, String country, String legalForm, String subscriptionType) {
    return create(name, addressMain, addressPostal, country, legalForm, subscriptionType, null, null, null, null, null, null, null);
  }

  public static BunqResponse<Long> create(String name, AddressObject addressMain, AddressObject addressPostal, String country, String legalForm, String subscriptionType, List<UboObject> ubo) {
    return create(name, addressMain, addressPostal, country, legalForm, subscriptionType, ubo, null, null, null, null, null, null);
  }

  public static BunqResponse<Long> create(String name, AddressObject addressMain, AddressObject addressPostal, String country, String legalForm, String subscriptionType, List<UboObject> ubo, String chamberOfCommerceNumber) {
  ...
  public static BunqResponse<Long> create(String name, AddressObject addressMain, AddressObject addressPostal, String country, String legalForm, String subscriptionType, List<UboObject> ubo, String chamberOfCommerceNumber, String avatarUuid) {
  ...
  public static BunqResponse<Long> create(String name, AddressObject addressMain, AddressObject addressPostal, String country, String legalForm, String subscriptionType, List<UboObject> ubo, String chamberOfCommerceNumber, String avatarUuid, CompanyVatNumberObject vatNumber) {
  ...
  public static BunqResponse<Long> create(String name, AddressObject addressMain, AddressObject addressPostal, String country, String legalForm, String subscriptionType, List<UboObject> ubo, String chamberOfCommerceNumber, String avatarUuid, CompanyVatNumberObject vatNumber, List<CompanyVatNumberObject> vatNumbers) {
  ...
  public static BunqResponse<CompanyApiObject> get(Long companyId, Map<String, String> params, Map<String, String> customHeaders) {
    ...
    return fromJson(CompanyApiObject.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<CompanyApiObject> get() {
  ...
  /**
   */
  public static BunqResponse<List<CompanyApiObject>> list(Map<String, String> params, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
    BunqResponseRaw responseRaw = apiClient.get(String.format(ENDPOINT_URL_LISTING, determineUserId()), params, customHeaders);

    return fromJsonList(CompanyApiObject.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<List<CompanyApiObject>> list() {
    return list(null, null);
  }

  public static BunqResponse<List<CompanyApiObject>> list(Map<String, String> params) {
...
requestMap.put(FIELD_AVATAR_UUID, avatarUuid);
  ...
  /**
   */
  public static CompanyApiObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(CompanyApiObject.class, reader);
  }
