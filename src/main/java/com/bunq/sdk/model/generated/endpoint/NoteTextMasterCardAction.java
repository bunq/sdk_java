 ...
 */
public class NoteTextMasterCardAction extends BunqModel {
    ...
    public NoteTextMasterCardAction() {
        this(null);
    }

    public NoteTextMasterCardAction(String content) {
     ...
     *
     */
    public static BunqResponse<NoteTextMasterCardAction> delete(Integer mastercardActionId, Integer noteTextMasterCardActionId, Integer monetaryAccountId, Map<String, String> customHeaders) {
        ApiClient apiClient = new ApiClient(getApiContext());
    ...
    public static BunqResponse<NoteTextMasterCardAction> delete(Integer mastercardActionId) {
        return delete(mastercardActionId, null, null, null);
    }

    public static BunqResponse<NoteTextMasterCardAction> delete(Integer mastercardActionId, Integer noteTextMasterCardActionId) {
        return delete(mastercardActionId, noteTextMasterCardActionId, null, null);
    }

    public static BunqResponse<NoteTextMasterCardAction> delete(Integer mastercardActionId, Integer noteTextMasterCardActionId, Integer monetaryAccountId) {
     ...
     */
    public static BunqResponse<List<NoteTextMasterCardAction>> list(Integer mastercardActionId, Integer monetaryAccountId, Map<String, String> params, Map<String, String> customHeaders) {
        ApiClient apiClient = new ApiClient(getApiContext());
        ...
        return fromJsonList(NoteTextMasterCardAction.class, responseRaw, OBJECT_TYPE_GET);
    }

    public static BunqResponse<List<NoteTextMasterCardAction>> list() {
        return list(null, null, null, null);
    }

    public static BunqResponse<List<NoteTextMasterCardAction>> list(Integer mastercardActionId) {
        return list(mastercardActionId, null, null, null);
    }

    public static BunqResponse<List<NoteTextMasterCardAction>> list(Integer mastercardActionId, Integer monetaryAccountId) {
        return list(mastercardActionId, monetaryAccountId, null, null);
    }

    public static BunqResponse<List<NoteTextMasterCardAction>> list(Integer mastercardActionId, Integer monetaryAccountId, Map<String, String> params) {
     ...
     *
     */
    public static BunqResponse<NoteTextMasterCardAction> get(Integer mastercardActionId, Integer noteTextMasterCardActionId, Integer monetaryAccountId, Map<String, String> params, Map<String, String> customHeaders) {
        ApiClient apiClient = new ApiClient(getApiContext());
        ...
        return fromJson(NoteTextMasterCardAction.class, responseRaw, OBJECT_TYPE_GET);
    }

    public static BunqResponse<NoteTextMasterCardAction> get() {
        return get(null, null, null, null, null);
    }

    public static BunqResponse<NoteTextMasterCardAction> get(Integer mastercardActionId) {
        return get(mastercardActionId, null, null, null, null);
    }

    public static BunqResponse<NoteTextMasterCardAction> get(Integer mastercardActionId, Integer noteTextMasterCardActionId) {
        return get(mastercardActionId, noteTextMasterCardActionId, null, null, null);
    }

    public static BunqResponse<NoteTextMasterCardAction> get(Integer mastercardActionId, Integer noteTextMasterCardActionId, Integer monetaryAccountId) {
        return get(mastercardActionId, noteTextMasterCardActionId, monetaryAccountId, null, null);
    }

    public static BunqResponse<NoteTextMasterCardAction> get(Integer mastercardActionId, Integer noteTextMasterCardActionId, Integer monetaryAccountId, Map<String, String> params) {
     ...
     *
     */
    public static NoteTextMasterCardAction fromJsonReader(JsonReader reader) {
        return fromJsonReader(NoteTextMasterCardAction.class, reader);
    }
