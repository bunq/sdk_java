...
/**
 */
public class ScheduleInstanceAnchorObjectObject extends BunqModel implements AnchorObjectInterface {
  ...
  /**
   */
  public static ScheduleInstanceAnchorObjectObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(ScheduleInstanceAnchorObjectObject.class, reader);
  }
