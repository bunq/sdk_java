...
/**
 */
public class DraftPaymentAnchorObjectObject extends BunqModel implements AnchorObjectInterface {
  ...
  /**
   */
  public static DraftPaymentAnchorObjectObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(DraftPaymentAnchorObjectObject.class, reader);
  }
