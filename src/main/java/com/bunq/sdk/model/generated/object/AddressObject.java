...
/**
 */
public class AddressObject extends BunqModel {
  ...
  public AddressObject(String street, String houseNumber) {
  this(street, houseNumber, null, null, null, null, null, null);
  }

  public AddressObject(String street, String houseNumber, String postalCode) {
  this(street, houseNumber, postalCode, null, null, null, null, null);
  }

  public AddressObject(String street, String houseNumber, String postalCode, String city) {
  this(street, houseNumber, postalCode, city, null, null, null, null);
  }

  public AddressObject(String street, String houseNumber, String postalCode, String city, String country) {
  this(street, houseNumber, postalCode, city, country, null, null, null);
  }

  public AddressObject(String street, String houseNumber, String postalCode, String city, String country, String poBox) {
  this(street, houseNumber, postalCode, city, country, poBox, null, null);
  }

  public AddressObject(String street, String houseNumber, String postalCode, String city, String country, String poBox, String extra) {
  this(street, houseNumber, postalCode, city, country, poBox, extra, null);
  }

  public AddressObject(String street, String houseNumber, String postalCode, String city, String country, String poBox, String extra, String mailboxName) {
  ...
  /**
   */
  public static AddressObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(AddressObject.class, reader);
  }
