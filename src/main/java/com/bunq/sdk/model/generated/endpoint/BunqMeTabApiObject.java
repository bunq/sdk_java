 ...
 * or SOFORT.
 */
public class BunqMeTabApiObject extends BunqModel {
  ...
  private LabelMonetaryAccountObject aliasMonetaryAccount;
  ...
  private BunqMeTabEntryApiObject bunqmeTabEntry;
  ...
  private List<BunqMeTabEntryApiObject> bunqmeTabEntries;
  ...
  private List<BunqMeTabResultInquiryApiObject> resultInquiries;
  ...
  private BunqMeTabEntryApiObject bunqmeTabEntryFieldForRequest;
  ...
  public BunqMeTabApiObject(BunqMeTabEntryApiObject bunqmeTabEntry) {
  this(bunqmeTabEntry, null, null);
  }

  public BunqMeTabApiObject(BunqMeTabEntryApiObject bunqmeTabEntry, String status) {
...
requestMap.put(FIELD_STATUS, status);
  ...
  public static BunqResponse<List<BunqMeTabApiObject>> list(Integer monetaryAccountId, Map<String, String> params, Map<String, String> customHeaders) {
    ...
    return fromJsonList(BunqMeTabApiObject.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<List<BunqMeTabApiObject>> list() {
  ...
  public static BunqResponse<BunqMeTabApiObject> get(Integer bunqMeTabId, Integer monetaryAccountId, Map<String, String> params, Map<String, String> customHeaders) {
    ...
    return fromJson(BunqMeTabApiObject.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<BunqMeTabApiObject> get() {
   ...
   * created the bunq.me link.
   */
  public LabelMonetaryAccountObject getAliasMonetaryAccount() {
    return this.aliasMonetaryAccount;
  }

  public void setAliasMonetaryAccount(LabelMonetaryAccountObject aliasMonetaryAccount) {
   ...
   * The bunq.me entry containing the payment information.
   */
  public BunqMeTabEntryApiObject getBunqmeTabEntry() {
    return this.bunqmeTabEntry;
  }

  public void setBunqmeTabEntry(BunqMeTabEntryApiObject bunqmeTabEntry) {
   ...
   * The bunq.me tab entries attached to this bunq.me Tab.
   */
  public List<BunqMeTabEntryApiObject> getBunqmeTabEntries() {
    return this.bunqmeTabEntries;
  }

  public void setBunqmeTabEntries(List<BunqMeTabEntryApiObject> bunqmeTabEntries) {
   ...
   * The list of bunq.me result Inquiries successfully made and paid.
   */
  public List<BunqMeTabResultInquiryApiObject> getResultInquiries() {
    return this.resultInquiries;
  }

  public void setResultInquiries(List<BunqMeTabResultInquiryApiObject> resultInquiries) {
  ...
  /**
   */
  public static BunqMeTabApiObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(BunqMeTabApiObject.class, reader);
  }
