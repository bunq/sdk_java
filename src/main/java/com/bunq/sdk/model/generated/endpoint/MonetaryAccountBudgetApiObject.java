 ...
 */
public class MonetaryAccountBudgetApiObject extends BunqModel {
  ...
  public MonetaryAccountBudgetApiObject(List<String> allCategory) {
  this(allCategory, null, null, null, null);
  }

  public MonetaryAccountBudgetApiObject(List<String> allCategory, AmountObject amount) {
  this(allCategory, amount, null, null, null);
  }

  public MonetaryAccountBudgetApiObject(List<String> allCategory, AmountObject amount, String recurrenceType) {
  ...
  /**
   */
  public static MonetaryAccountBudgetApiObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(MonetaryAccountBudgetApiObject.class, reader);
  }
