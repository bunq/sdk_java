...
/**
 */
public class CardCountryPermissionObject extends BunqModel {
  ...
  public CardCountryPermissionObject() {
  this(null, null);
  }
  ...
  public CardCountryPermissionObject(String country, String expiryTime) {
  ...
  /**
   */
  public static CardCountryPermissionObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(CardCountryPermissionObject.class, reader);
  }
