 ...
 */
public class NoteAttachmentScheduleRequestBatch extends BunqModel {
  ...
  public NoteAttachmentScheduleRequestBatch() {
  this(null, null);
  }

  public NoteAttachmentScheduleRequestBatch(Integer attachmentId) {
  this(attachmentId, null);
  }

  public NoteAttachmentScheduleRequestBatch(Integer attachmentId, String description) {
...
requestMap.put(FIELD_DESCRIPTION, description);
  ...
  /**
   */
  public static BunqResponse<NoteAttachmentScheduleRequestBatch> delete(Integer scheduleRequestInquiryBatchId, Integer noteAttachmentScheduleRequestBatchId, Integer monetaryAccountId, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
  ...
  public static BunqResponse<NoteAttachmentScheduleRequestBatch> delete(Integer scheduleRequestInquiryBatchId) {
    return delete(scheduleRequestInquiryBatchId, null, null, null);
  }

  public static BunqResponse<NoteAttachmentScheduleRequestBatch> delete(Integer scheduleRequestInquiryBatchId, Integer noteAttachmentScheduleRequestBatchId) {
    return delete(scheduleRequestInquiryBatchId, noteAttachmentScheduleRequestBatchId, null, null);
  }

  public static BunqResponse<NoteAttachmentScheduleRequestBatch> delete(Integer scheduleRequestInquiryBatchId, Integer noteAttachmentScheduleRequestBatchId, Integer monetaryAccountId) {
   ...
   */
  public static BunqResponse<List<NoteAttachmentScheduleRequestBatch>> list(Integer scheduleRequestInquiryBatchId, Integer monetaryAccountId, Map<String, String> params, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
    ...
    return fromJsonList(NoteAttachmentScheduleRequestBatch.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<List<NoteAttachmentScheduleRequestBatch>> list() {
    return list(null, null, null, null);
  }

  public static BunqResponse<List<NoteAttachmentScheduleRequestBatch>> list(Integer scheduleRequestInquiryBatchId) {
    return list(scheduleRequestInquiryBatchId, null, null, null);
  }

  public static BunqResponse<List<NoteAttachmentScheduleRequestBatch>> list(Integer scheduleRequestInquiryBatchId, Integer monetaryAccountId) {
    return list(scheduleRequestInquiryBatchId, monetaryAccountId, null, null);
  }

  public static BunqResponse<List<NoteAttachmentScheduleRequestBatch>> list(Integer scheduleRequestInquiryBatchId, Integer monetaryAccountId, Map<String, String> params) {
    return list(scheduleRequestInquiryBatchId, monetaryAccountId, params, null);
  }

  /**
   */
  public static BunqResponse<NoteAttachmentScheduleRequestBatch> get(Integer scheduleRequestInquiryBatchId, Integer noteAttachmentScheduleRequestBatchId, Integer monetaryAccountId, Map<String, String> params, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
    ...
    return fromJson(NoteAttachmentScheduleRequestBatch.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<NoteAttachmentScheduleRequestBatch> get() {
    return get(null, null, null, null, null);
  }

  public static BunqResponse<NoteAttachmentScheduleRequestBatch> get(Integer scheduleRequestInquiryBatchId) {
    return get(scheduleRequestInquiryBatchId, null, null, null, null);
  }

  public static BunqResponse<NoteAttachmentScheduleRequestBatch> get(Integer scheduleRequestInquiryBatchId, Integer noteAttachmentScheduleRequestBatchId) {
    return get(scheduleRequestInquiryBatchId, noteAttachmentScheduleRequestBatchId, null, null, null);
  }

  public static BunqResponse<NoteAttachmentScheduleRequestBatch> get(Integer scheduleRequestInquiryBatchId, Integer noteAttachmentScheduleRequestBatchId, Integer monetaryAccountId) {
    return get(scheduleRequestInquiryBatchId, noteAttachmentScheduleRequestBatchId, monetaryAccountId, null, null);
  }

  public static BunqResponse<NoteAttachmentScheduleRequestBatch> get(Integer scheduleRequestInquiryBatchId, Integer noteAttachmentScheduleRequestBatchId, Integer monetaryAccountId, Map<String, String> params) {
  ...
  /**
   */
  public static NoteAttachmentScheduleRequestBatch fromJsonReader(JsonReader reader) {
    return fromJsonReader(NoteAttachmentScheduleRequestBatch.class, reader);
  }
