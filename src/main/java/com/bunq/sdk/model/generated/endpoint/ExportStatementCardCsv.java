 ...
 */
public class ExportStatementCardCsv extends BunqModel {
  ...
  public ExportStatementCardCsv() {
  this(null, null, null);
  }

  public ExportStatementCardCsv(String dateStart) {
  this(dateStart, null, null);
  }

  public ExportStatementCardCsv(String dateStart, String dateEnd) {
  this(dateStart, dateEnd, null);
  }

  public ExportStatementCardCsv(String dateStart, String dateEnd, String regionalFormat) {
...
requestMap.put(FIELD_REGIONAL_FORMAT, regionalFormat);
  ...
  /**
   */
  public static BunqResponse<ExportStatementCardCsv> get(Integer cardId, Integer exportStatementCardCsvId, Map<String, String> params, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
    ...
    return fromJson(ExportStatementCardCsv.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<ExportStatementCardCsv> get() {
    return get(null, null, null, null);
  }

  public static BunqResponse<ExportStatementCardCsv> get(Integer cardId) {
    return get(cardId, null, null, null);
  }

  public static BunqResponse<ExportStatementCardCsv> get(Integer cardId, Integer exportStatementCardCsvId) {
    return get(cardId, exportStatementCardCsvId, null, null);
  }

  public static BunqResponse<ExportStatementCardCsv> get(Integer cardId, Integer exportStatementCardCsvId, Map<String, String> params) {
    return get(cardId, exportStatementCardCsvId, params, null);
  }

  /**
   */
  public static BunqResponse<List<ExportStatementCardCsv>> list(Integer cardId, Map<String, String> params, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
    BunqResponseRaw responseRaw = apiClient.get(String.format(ENDPOINT_URL_LISTING, determineUserId(), cardId), params, customHeaders);

    return fromJsonList(ExportStatementCardCsv.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<List<ExportStatementCardCsv>> list() {
    return list(null, null, null);
  }

  public static BunqResponse<List<ExportStatementCardCsv>> list(Integer cardId) {
    return list(cardId, null, null);
  }

  public static BunqResponse<List<ExportStatementCardCsv>> list(Integer cardId, Map<String, String> params) {
    return list(cardId, params, null);
  }

  /**
   */
  public static BunqResponse<ExportStatementCardCsv> delete(Integer cardId, Integer exportStatementCardCsvId, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
  ...
  public static BunqResponse<ExportStatementCardCsv> delete(Integer cardId) {
    return delete(cardId, null, null);
  }

  public static BunqResponse<ExportStatementCardCsv> delete(Integer cardId, Integer exportStatementCardCsvId) {
  ...
  /**
   */
  public static ExportStatementCardCsv fromJsonReader(JsonReader reader) {
    return fromJsonReader(ExportStatementCardCsv.class, reader);
  }
