 ...
 */
public class TransferwiseAccountQuoteApiObject extends BunqModel {
  ...
  public TransferwiseAccountQuoteApiObject() {
  this(null, null, null, null);
  }

  public TransferwiseAccountQuoteApiObject(String nameAccountHolder) {
  this(nameAccountHolder, null, null, null);
  }

  public TransferwiseAccountQuoteApiObject(String nameAccountHolder, String type) {
  this(nameAccountHolder, type, null, null);
  }

  public TransferwiseAccountQuoteApiObject(String nameAccountHolder, String type, String country) {
  this(nameAccountHolder, type, country, null);
  }

  public TransferwiseAccountQuoteApiObject(String nameAccountHolder, String type, String country, List<TransferwiseRequirementFieldObject> detail) {
   ...
   */
  public static BunqResponse<Integer> create(Integer transferwiseQuoteId, String nameAccountHolder, String type, String country, List<TransferwiseRequirementFieldObject> detail, Map<String, String> customHeaders) {
...
requestMap.put(FIELD_DETAIL, detail);
  ...
  public static BunqResponse<Integer> create(Integer transferwiseQuoteId, String nameAccountHolder, String type, String country, List<TransferwiseRequirementFieldObject> detail) {
    return create(transferwiseQuoteId, nameAccountHolder, type, country, detail, null);
  }

  /**
   */
  public static BunqResponse<TransferwiseAccountQuoteApiObject> get(Integer transferwiseQuoteId, Integer transferwiseAccountQuoteId, Map<String, String> params, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
    ...
    return fromJson(TransferwiseAccountQuoteApiObject.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<TransferwiseAccountQuoteApiObject> get() {
    return get(null, null, null, null);
  }

  public static BunqResponse<TransferwiseAccountQuoteApiObject> get(Integer transferwiseQuoteId) {
    return get(transferwiseQuoteId, null, null, null);
  }

  public static BunqResponse<TransferwiseAccountQuoteApiObject> get(Integer transferwiseQuoteId, Integer transferwiseAccountQuoteId) {
    return get(transferwiseQuoteId, transferwiseAccountQuoteId, null, null);
  }

  public static BunqResponse<TransferwiseAccountQuoteApiObject> get(Integer transferwiseQuoteId, Integer transferwiseAccountQuoteId, Map<String, String> params) {
    return get(transferwiseQuoteId, transferwiseAccountQuoteId, params, null);
  }

  /**
   */
  public static BunqResponse<List<TransferwiseAccountQuoteApiObject>> list(Integer transferwiseQuoteId, Map<String, String> params, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
    ...
    return fromJsonList(TransferwiseAccountQuoteApiObject.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<List<TransferwiseAccountQuoteApiObject>> list() {
    return list(null, null, null);
  }

  public static BunqResponse<List<TransferwiseAccountQuoteApiObject>> list(Integer transferwiseQuoteId) {
    return list(transferwiseQuoteId, null, null);
  }

  public static BunqResponse<List<TransferwiseAccountQuoteApiObject>> list(Integer transferwiseQuoteId, Map<String, String> params) {
    return list(transferwiseQuoteId, params, null);
  }

  /**
   */
  public static BunqResponse<TransferwiseAccountQuoteApiObject> delete(Integer transferwiseQuoteId, Integer transferwiseAccountQuoteId, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
  ...
  public static BunqResponse<TransferwiseAccountQuoteApiObject> delete(Integer transferwiseQuoteId) {
    return delete(transferwiseQuoteId, null, null);
  }

  public static BunqResponse<TransferwiseAccountQuoteApiObject> delete(Integer transferwiseQuoteId, Integer transferwiseAccountQuoteId) {
  ...
  /**
   */
  public static TransferwiseAccountQuoteApiObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(TransferwiseAccountQuoteApiObject.class, reader);
  }
