...
requestMap.put(FIELD_DETAIL, detail);
  ...
  /**
   */
  public static BunqResponse<TransferwiseAccountQuoteApiObject> get(Long transferwiseQuoteId, Long transferwiseAccountQuoteId, Map<String, String> params, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
  ...
  public static BunqResponse<TransferwiseAccountQuoteApiObject> get(Long transferwiseQuoteId) {
    return get(transferwiseQuoteId, null, null, null);
  }

  public static BunqResponse<TransferwiseAccountQuoteApiObject> get(Long transferwiseQuoteId, Long transferwiseAccountQuoteId) {
    return get(transferwiseQuoteId, transferwiseAccountQuoteId, null, null);
  }

  public static BunqResponse<TransferwiseAccountQuoteApiObject> get(Long transferwiseQuoteId, Long transferwiseAccountQuoteId, Map<String, String> params) {
    return get(transferwiseQuoteId, transferwiseAccountQuoteId, params, null);
  }

  /**
   */
  public static BunqResponse<List<TransferwiseAccountQuoteApiObject>> list(Long transferwiseQuoteId, Map<String, String> params, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
  ...
  public static BunqResponse<List<TransferwiseAccountQuoteApiObject>> list(Long transferwiseQuoteId) {
    return list(transferwiseQuoteId, null, null);
  }

  public static BunqResponse<List<TransferwiseAccountQuoteApiObject>> list(Long transferwiseQuoteId, Map<String, String> params) {
    return list(transferwiseQuoteId, params, null);
  }

  /**
   */
  public static BunqResponse<TransferwiseAccountQuoteApiObject> delete(Long transferwiseQuoteId, Long transferwiseAccountQuoteId, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
  ...
  public static BunqResponse<TransferwiseAccountQuoteApiObject> delete(Long transferwiseQuoteId) {
    return delete(transferwiseQuoteId, null, null);
  }

  public static BunqResponse<TransferwiseAccountQuoteApiObject> delete(Long transferwiseQuoteId, Long transferwiseAccountQuoteId) {
