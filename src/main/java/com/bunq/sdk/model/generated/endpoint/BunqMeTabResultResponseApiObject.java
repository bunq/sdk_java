 ...
 */
public class BunqMeTabResultResponseApiObject extends BunqModel {
  ...
  public static BunqResponse<BunqMeTabResultResponseApiObject> get(Integer bunqMeTabResultResponseId, Integer monetaryAccountId, Map<String, String> params, Map<String, String> customHeaders) {
    ...
    return fromJson(BunqMeTabResultResponseApiObject.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<BunqMeTabResultResponseApiObject> get() {
  ...
  /**
   */
  public static BunqMeTabResultResponseApiObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(BunqMeTabResultResponseApiObject.class, reader);
  }
