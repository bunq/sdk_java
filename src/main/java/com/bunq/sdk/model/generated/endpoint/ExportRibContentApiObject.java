...
public class ExportRibContentApiObject extends BunqModel {
   ...
   */
  public static BunqResponse<byte[]> list(Long exportRibId, Long monetaryAccountId, Map<String, String> params, Map<String, String> customHeaders) {
  ...
  public static BunqResponse<byte[]> list(Long exportRibId) {
    return list(exportRibId, null, null, null);
  }
  public static BunqResponse<byte[]> list(Long exportRibId, Long monetaryAccountId) {
    return list(exportRibId, monetaryAccountId, null, null);
  }
  public static BunqResponse<byte[]> list(Long exportRibId, Long monetaryAccountId, Map<String, String> params) {
