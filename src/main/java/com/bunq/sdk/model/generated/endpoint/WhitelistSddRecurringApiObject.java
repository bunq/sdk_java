 ...
 * accepted.
 */
public class WhitelistSddRecurringApiObject extends BunqModel {
  ...
  private AmountObject maximumAmountPerPayment;
  ...
  private AmountObject maximumAmountPerPaymentFieldForRequest;
  ...
  public WhitelistSddRecurringApiObject() {
  this(null, null, null, null, null);
  }

  public WhitelistSddRecurringApiObject(Integer monetaryAccountPayingId) {
  this(monetaryAccountPayingId, null, null, null, null);
  }

  public WhitelistSddRecurringApiObject(Integer monetaryAccountPayingId, Integer requestId) {
  this(monetaryAccountPayingId, requestId, null, null, null);
  }

  public WhitelistSddRecurringApiObject(Integer monetaryAccountPayingId, Integer requestId, AmountObject maximumAmountPerMonth) {
  this(monetaryAccountPayingId, requestId, maximumAmountPerMonth, null, null);
  }

  public WhitelistSddRecurringApiObject(Integer monetaryAccountPayingId, Integer requestId, AmountObject maximumAmountPerMonth, AmountObject maximumAmountPerPayment) {
  this(monetaryAccountPayingId, requestId, maximumAmountPerMonth, maximumAmountPerPayment, null);
  }

  public WhitelistSddRecurringApiObject(Integer monetaryAccountPayingId, Integer requestId, AmountObject maximumAmountPerMonth, AmountObject maximumAmountPerPayment, String routingType) {
   ...
   */
  public static BunqResponse<WhitelistSddRecurringApiObject> get(Integer whitelistSddRecurringId, Map<String, String> params, Map<String, String> customHeaders) {
    ...
    return fromJson(WhitelistSddRecurringApiObject.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<WhitelistSddRecurringApiObject> get() {
    return get(null, null, null);
  }

  public static BunqResponse<WhitelistSddRecurringApiObject> get(Integer whitelistSddRecurringId) {
    return get(whitelistSddRecurringId, null, null);
  }

  public static BunqResponse<WhitelistSddRecurringApiObject> get(Integer whitelistSddRecurringId, Map<String, String> params) {
   ...
   * CIT/technical#12806.
   */
  public static BunqResponse<Long> create(Integer monetaryAccountPayingId, Integer requestId, AmountObject maximumAmountPerMonth, AmountObject maximumAmountPerPayment, String routingType, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
...
requestMap.put(FIELD_ROUTING_TYPE, routingType);
  ...
  public static BunqResponse<Long> create(Integer monetaryAccountPayingId) {
    return create(monetaryAccountPayingId, null, null, null, null, null);
  }

  public static BunqResponse<Long> create(Integer monetaryAccountPayingId, Integer requestId) {
    return create(monetaryAccountPayingId, requestId, null, null, null, null);
  }

  public static BunqResponse<Long> create(Integer monetaryAccountPayingId, Integer requestId, AmountObject maximumAmountPerMonth) {
    return create(monetaryAccountPayingId, requestId, maximumAmountPerMonth, null, null, null);
  }

  public static BunqResponse<Long> create(Integer monetaryAccountPayingId, Integer requestId, AmountObject maximumAmountPerMonth, AmountObject maximumAmountPerPayment) {
    return create(monetaryAccountPayingId, requestId, maximumAmountPerMonth, maximumAmountPerPayment, null, null);
  }

  public static BunqResponse<Long> create(Integer monetaryAccountPayingId, Integer requestId, AmountObject maximumAmountPerMonth, AmountObject maximumAmountPerPayment, String routingType) {
   ...
   * CIT/technical#12806.
   */
  public static BunqResponse<Long> update(Integer whitelistSddRecurringId, Integer monetaryAccountPayingId, AmountObject maximumAmountPerMonth, AmountObject maximumAmountPerPayment, String routingType, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
...
requestMap.put(FIELD_ROUTING_TYPE, routingType);
  ...
  public static BunqResponse<Long> update(Integer whitelistSddRecurringId) {
    return update(whitelistSddRecurringId, null, null, null, null, null);
  }

  public static BunqResponse<Long> update(Integer whitelistSddRecurringId, Integer monetaryAccountPayingId) {
    return update(whitelistSddRecurringId, monetaryAccountPayingId, null, null, null, null);
  }

  public static BunqResponse<Long> update(Integer whitelistSddRecurringId, Integer monetaryAccountPayingId, AmountObject maximumAmountPerMonth) {
    return update(whitelistSddRecurringId, monetaryAccountPayingId, maximumAmountPerMonth, null, null, null);
  }

  public static BunqResponse<Long> update(Integer whitelistSddRecurringId, Integer monetaryAccountPayingId, AmountObject maximumAmountPerMonth, AmountObject maximumAmountPerPayment) {
    return update(whitelistSddRecurringId, monetaryAccountPayingId, maximumAmountPerMonth, maximumAmountPerPayment, null, null);
  }

  public static BunqResponse<Long> update(Integer whitelistSddRecurringId, Integer monetaryAccountPayingId, AmountObject maximumAmountPerMonth, AmountObject maximumAmountPerPayment, String routingType) {
  ...
  /**
   */
  public static BunqResponse<WhitelistSddRecurringApiObject> delete(Integer whitelistSddRecurringId, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
  ...
  public static BunqResponse<WhitelistSddRecurringApiObject> delete(Integer whitelistSddRecurringId) {
   ...
   */
  public static BunqResponse<List<WhitelistSddRecurringApiObject>> list(Map<String, String> params, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
    BunqResponseRaw responseRaw = apiClient.get(String.format(ENDPOINT_URL_LISTING, determineUserId()), params, customHeaders);

    return fromJsonList(WhitelistSddRecurringApiObject.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<List<WhitelistSddRecurringApiObject>> list() {
    return list(null, null);
  }

  public static BunqResponse<List<WhitelistSddRecurringApiObject>> list(Map<String, String> params) {
   ...
   * The maximum amount per payment that can be deducted from the target account.
   */
  public AmountObject getMaximumAmountPerPayment() {
    return this.maximumAmountPerPayment;
  }

  public void setMaximumAmountPerPayment(AmountObject maximumAmountPerPayment) {
  ...
  /**
   */
  public static WhitelistSddRecurringApiObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(WhitelistSddRecurringApiObject.class, reader);
  }
