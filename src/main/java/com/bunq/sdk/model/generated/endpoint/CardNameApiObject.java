 ...
 */
public class CardNameApiObject extends BunqModel {
  ...
  public CardNameApiObject() {
  this(null);
  }

  public CardNameApiObject(String name) {
    this.nameFieldForRequest = name;
  }  /**
   * Return all the accepted card names for a specific user.
   */
  public static BunqResponse<List<CardNameApiObject>> list(Map<String, String> params, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
    BunqResponseRaw responseRaw = apiClient.get(String.format(ENDPOINT_URL_LISTING, determineUserId()), params, customHeaders);

    return fromJsonList(CardNameApiObject.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<List<CardNameApiObject>> list() {
    return list(null, null);
  }

  public static BunqResponse<List<CardNameApiObject>> list(Map<String, String> params) {
  ...
  /**
   */
  public static CardNameApiObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(CardNameApiObject.class, reader);
  }
