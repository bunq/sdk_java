 ...
 */
public class MasterCardIdentityCheckChallengeRequestUserApiObject extends BunqModel {
  ...
  public MasterCardIdentityCheckChallengeRequestUserApiObject() {
  this(null);
  }

  public MasterCardIdentityCheckChallengeRequestUserApiObject(String status) {
  ...
  public static BunqResponse<MasterCardIdentityCheckChallengeRequestUserApiObject> get(Integer masterCardIdentityCheckChallengeRequestUserId, Map<String, String> params, Map<String, String> customHeaders) {
    ...
    return fromJson(MasterCardIdentityCheckChallengeRequestUserApiObject.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<MasterCardIdentityCheckChallengeRequestUserApiObject> get() {
...
requestMap.put(FIELD_STATUS, status);
  ...
  /**
   */
  public static MasterCardIdentityCheckChallengeRequestUserApiObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(MasterCardIdentityCheckChallengeRequestUserApiObject.class, reader);
  }
