 ...
 */
public class AttachmentPublicContentApiObject extends BunqModel {
  ...
  /**
   */
  public static AttachmentPublicContentApiObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(AttachmentPublicContentApiObject.class, reader);
  }
