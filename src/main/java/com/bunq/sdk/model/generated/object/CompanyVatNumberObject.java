...
/**
 */
public class CompanyVatNumberObject extends BunqModel {
  ...
  public CompanyVatNumberObject() {
  this(null, null, null);
  }

  public CompanyVatNumberObject(String country) {
  this(country, null, null);
  }

  public CompanyVatNumberObject(String country, String value) {
  this(country, value, null);
  }

  public CompanyVatNumberObject(String country, String value, String type) {
  ...
  /**
   */
  public static CompanyVatNumberObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(CompanyVatNumberObject.class, reader);
  }
