 ...
 */
public class OpenBankingProviderBankApiObject extends BunqModel {
  ...
  public OpenBankingProviderBankApiObject() {
  this(null, null);
  }

  public OpenBankingProviderBankApiObject(String accountInformationServiceStatus) {
  this(accountInformationServiceStatus, null);
  }

  public OpenBankingProviderBankApiObject(String accountInformationServiceStatus, String paymentInformationServiceStatus) {
  ...
  /**
   */
  public static OpenBankingProviderBankApiObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(OpenBankingProviderBankApiObject.class, reader);
  }
