 ...
 */
public class PaymentServiceProviderDraftPayment extends BunqModel {
    ...
    public PaymentServiceProviderDraftPayment() {
        this(null, null, null, null, null, null, null);
    }

    public PaymentServiceProviderDraftPayment(String senderIban) {
        this(senderIban, null, null, null, null, null, null);
    }

    public PaymentServiceProviderDraftPayment(String senderIban, String counterpartyIban) {
        this(senderIban, counterpartyIban, null, null, null, null, null);
    }

    public PaymentServiceProviderDraftPayment(String senderIban, String counterpartyIban, String counterpartyName) {
        this(senderIban, counterpartyIban, counterpartyName, null, null, null, null);
    }

    public PaymentServiceProviderDraftPayment(String senderIban, String counterpartyIban, String counterpartyName, String description) {
        this(senderIban, counterpartyIban, counterpartyName, description, null, null, null);
    }

    public PaymentServiceProviderDraftPayment(String senderIban, String counterpartyIban, String counterpartyName, String description, Amount amount) {
        this(senderIban, counterpartyIban, counterpartyName, description, amount, null, null);
    }

    public PaymentServiceProviderDraftPayment(String senderIban, String counterpartyIban, String counterpartyName, String description, Amount amount, String senderName) {
        this(senderIban, counterpartyIban, counterpartyName, description, amount, senderName, null);
    }

    public PaymentServiceProviderDraftPayment(String senderIban, String counterpartyIban, String counterpartyName, String description, Amount amount, String senderName, String status) {
     ...
     *                         by update.
     */
    public static BunqResponse<Integer> create(String senderIban, String counterpartyIban, String counterpartyName, String description, Amount amount, String senderName, String status, Map<String, String> customHeaders) {
    ...
    public static BunqResponse<Integer> create(String senderIban, String counterpartyIban, String counterpartyName, String description, Amount amount) {
        return create(senderIban, counterpartyIban, counterpartyName, description, amount, null, null, null);
    }

    public static BunqResponse<Integer> create(String senderIban, String counterpartyIban, String counterpartyName, String description, Amount amount, String senderName) {
        return create(senderIban, counterpartyIban, counterpartyName, description, amount, senderName, null, null);
    }

    public static BunqResponse<Integer> create(String senderIban, String counterpartyIban, String counterpartyName, String description, Amount amount, String senderName, String status) {
     ...
     *
     */
    public static BunqResponse<List<PaymentServiceProviderDraftPayment>> list(Map<String, String> params, Map<String, String> customHeaders) {
        ApiClient apiClient = new ApiClient(getApiContext());
        BunqResponseRaw responseRaw = apiClient.get(String.format(ENDPOINT_URL_LISTING, determineUserId()), params, customHeaders);

        return fromJsonList(PaymentServiceProviderDraftPayment.class, responseRaw, OBJECT_TYPE_GET);
    }
    ...
    public static BunqResponse<List<PaymentServiceProviderDraftPayment>> list(Map<String, String> params) {
     ...
     *
     */
    public static BunqResponse<PaymentServiceProviderDraftPayment> get(Integer paymentServiceProviderDraftPaymentId, Map<String, String> params, Map<String, String> customHeaders) {
        ApiClient apiClient = new ApiClient(getApiContext());
        ...
        return fromJson(PaymentServiceProviderDraftPayment.class, responseRaw, OBJECT_TYPE_GET);
    }

    public static BunqResponse<PaymentServiceProviderDraftPayment> get() {
        return get(null, null, null);
    }

    public static BunqResponse<PaymentServiceProviderDraftPayment> get(Integer paymentServiceProviderDraftPaymentId) {
        return get(paymentServiceProviderDraftPaymentId, null, null);
    }

    public static BunqResponse<PaymentServiceProviderDraftPayment> get(Integer paymentServiceProviderDraftPaymentId, Map<String, String> params) {
     ...
     *
     */
    public static PaymentServiceProviderDraftPayment fromJsonReader(JsonReader reader) {
        return fromJsonReader(PaymentServiceProviderDraftPayment.class, reader);
    }
