...
public class CardDebit extends BunqModel {
  ...
  public CardDebit(String secondLine, String nameOnCard, String type, String productType) {
  this(secondLine, nameOnCard, type, productType, null, null, null, null, null);
  }

  public CardDebit(String secondLine, String nameOnCard, String type, String productType, String preferredNameOnCard) {
  this(secondLine, nameOnCard, type, productType, preferredNameOnCard, null, null, null, null);
  }

  public CardDebit(String secondLine, String nameOnCard, String type, String productType, String preferredNameOnCard, Pointer alias) {
  this(secondLine, nameOnCard, type, productType, preferredNameOnCard, alias, null, null, null);
  }

  public CardDebit(String secondLine, String nameOnCard, String type, String productType, String preferredNameOnCard, Pointer alias, List<CardPinAssignment> pinCodeAssignment) {
  this(secondLine, nameOnCard, type, productType, preferredNameOnCard, alias, pinCodeAssignment, null, null);
  }

  public CardDebit(String secondLine, String nameOnCard, String type, String productType, String preferredNameOnCard, Pointer alias, List<CardPinAssignment> pinCodeAssignment, Integer monetaryAccountIdFallback) {
  this(secondLine, nameOnCard, type, productType, preferredNameOnCard, alias, pinCodeAssignment, monetaryAccountIdFallback, null);
  }

  public CardDebit(String secondLine, String nameOnCard, String type, String productType, String preferredNameOnCard, Pointer alias, List<CardPinAssignment> pinCodeAssignment, Integer monetaryAccountIdFallback, String orderStatus) {
   ...
   * VIRTUAL_DELIVERY.
   */
  public static BunqResponse<CardDebit> create(String secondLine, String nameOnCard, String type, String productType, String preferredNameOnCard, Pointer alias, List<CardPinAssignment> pinCodeAssignment, Integer monetaryAccountIdFallback, String orderStatus, Map<String, String> customHeaders) {
...
requestMap.put(FIELD_ORDER_STATUS, orderStatus);
  ...
  public static BunqResponse<CardDebit> create(String secondLine, String nameOnCard, String type, String productType) {
    return create(secondLine, nameOnCard, type, productType, null, null, null, null, null, null);
  }

  public static BunqResponse<CardDebit> create(String secondLine, String nameOnCard, String type, String productType, String preferredNameOnCard) {
    return create(secondLine, nameOnCard, type, productType, preferredNameOnCard, null, null, null, null, null);
  }

  public static BunqResponse<CardDebit> create(String secondLine, String nameOnCard, String type, String productType, String preferredNameOnCard, Pointer alias) {
    return create(secondLine, nameOnCard, type, productType, preferredNameOnCard, alias, null, null, null, null);
  }

  public static BunqResponse<CardDebit> create(String secondLine, String nameOnCard, String type, String productType, String preferredNameOnCard, Pointer alias, List<CardPinAssignment> pinCodeAssignment) {
    return create(secondLine, nameOnCard, type, productType, preferredNameOnCard, alias, pinCodeAssignment, null, null, null);
  }

  public static BunqResponse<CardDebit> create(String secondLine, String nameOnCard, String type, String productType, String preferredNameOnCard, Pointer alias, List<CardPinAssignment> pinCodeAssignment, Integer monetaryAccountIdFallback) {
  ...
  public static BunqResponse<CardDebit> create(String secondLine, String nameOnCard, String type, String productType, String preferredNameOnCard, Pointer alias, List<CardPinAssignment> pinCodeAssignment, Integer monetaryAccountIdFallback, String orderStatus) {
