 ...
 */
public class NoteAttachmentPayment extends BunqModel {
  ...
  public NoteAttachmentPayment() {
    this(null, null);
  }

  public NoteAttachmentPayment(Integer attachmentId) {
    this(attachmentId, null);
  }

  public NoteAttachmentPayment(Integer attachmentId, String description) {
  ...
  /**
   */
  public static BunqResponse<NoteAttachmentPayment> delete(Integer paymentId, Integer noteAttachmentPaymentId, Integer monetaryAccountId, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
  ...
  public static BunqResponse<NoteAttachmentPayment> delete(Integer paymentId) {
    return delete(paymentId, null, null, null);
  }

  public static BunqResponse<NoteAttachmentPayment> delete(Integer paymentId, Integer noteAttachmentPaymentId) {
    return delete(paymentId, noteAttachmentPaymentId, null, null);
  }

  public static BunqResponse<NoteAttachmentPayment> delete(Integer paymentId, Integer noteAttachmentPaymentId, Integer monetaryAccountId) {
   ...
   */
  public static BunqResponse<List<NoteAttachmentPayment>> list(Integer paymentId, Integer monetaryAccountId, Map<String, String> params, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
    ...
    return fromJsonList(NoteAttachmentPayment.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<List<NoteAttachmentPayment>> list() {
    return list(null, null, null, null);
  }

  public static BunqResponse<List<NoteAttachmentPayment>> list(Integer paymentId) {
    return list(paymentId, null, null, null);
  }

  public static BunqResponse<List<NoteAttachmentPayment>> list(Integer paymentId, Integer monetaryAccountId) {
    return list(paymentId, monetaryAccountId, null, null);
  }

  public static BunqResponse<List<NoteAttachmentPayment>> list(Integer paymentId, Integer monetaryAccountId, Map<String, String> params) {
    return list(paymentId, monetaryAccountId, params, null);
  }

  /**
   */
  public static BunqResponse<NoteAttachmentPayment> get(Integer paymentId, Integer noteAttachmentPaymentId, Integer monetaryAccountId, Map<String, String> params, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
    ...
    return fromJson(NoteAttachmentPayment.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<NoteAttachmentPayment> get() {
    return get(null, null, null, null, null);
  }

  public static BunqResponse<NoteAttachmentPayment> get(Integer paymentId) {
    return get(paymentId, null, null, null, null);
  }

  public static BunqResponse<NoteAttachmentPayment> get(Integer paymentId, Integer noteAttachmentPaymentId) {
    return get(paymentId, noteAttachmentPaymentId, null, null, null);
  }

  public static BunqResponse<NoteAttachmentPayment> get(Integer paymentId, Integer noteAttachmentPaymentId, Integer monetaryAccountId) {
    return get(paymentId, noteAttachmentPaymentId, monetaryAccountId, null, null);
  }

  public static BunqResponse<NoteAttachmentPayment> get(Integer paymentId, Integer noteAttachmentPaymentId, Integer monetaryAccountId, Map<String, String> params) {
    return get(paymentId, noteAttachmentPaymentId, monetaryAccountId, params, null);
  }

  /**
   */
  public static NoteAttachmentPayment fromJsonReader(JsonReader reader) {
    return fromJsonReader(NoteAttachmentPayment.class, reader);
  }
