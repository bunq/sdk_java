...
public class CardReplace extends BunqModel {
  ...
  public CardReplace(String nameOnCard, String preferredNameOnCard) {
  this(nameOnCard, preferredNameOnCard, null, null);
  }

  public CardReplace(String nameOnCard, String preferredNameOnCard, List<CardPinAssignment> pinCodeAssignment) {
  this(nameOnCard, preferredNameOnCard, pinCodeAssignment, null);
  }

  public CardReplace(String nameOnCard, String preferredNameOnCard, List<CardPinAssignment> pinCodeAssignment, String secondLine) {
   ...
   */
  public static BunqResponse<Integer> create(Integer cardId, String nameOnCard, String preferredNameOnCard, List<CardPinAssignment> pinCodeAssignment, String secondLine, Map<String, String> customHeaders) {
...
requestMap.put(FIELD_SECOND_LINE, secondLine);
  ...
  public static BunqResponse<Integer> create(Integer cardId, String nameOnCard, String preferredNameOnCard, List<CardPinAssignment> pinCodeAssignment) {
    return create(cardId, nameOnCard, preferredNameOnCard, pinCodeAssignment, null, null);
  }

  public static BunqResponse<Integer> create(Integer cardId, String nameOnCard, String preferredNameOnCard, List<CardPinAssignment> pinCodeAssignment, String secondLine) {
