 ...
 */
public class AttachmentUserContentApiObject extends BunqModel {
  ...
  /**
   */
  public static AttachmentUserContentApiObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(AttachmentUserContentApiObject.class, reader);
  }
