 ...
 */
public class CurrencyCloudBeneficiaryApiObject extends BunqModel {
  ...
  public CurrencyCloudBeneficiaryApiObject() {
  this(null, null, null, null, null, null);
  }

  public CurrencyCloudBeneficiaryApiObject(String name) {
  this(name, null, null, null, null, null);
  }

  public CurrencyCloudBeneficiaryApiObject(String name, String country) {
  this(name, country, null, null, null, null);
  }

  public CurrencyCloudBeneficiaryApiObject(String name, String country, String currency) {
  this(name, country, currency, null, null, null);
  }

  public CurrencyCloudBeneficiaryApiObject(String name, String country, String currency, String paymentType) {
  this(name, country, currency, paymentType, null, null);
  }

  public CurrencyCloudBeneficiaryApiObject(String name, String country, String currency, String paymentType, String legalEntityType) {
  this(name, country, currency, paymentType, legalEntityType, null);
  }

  public CurrencyCloudBeneficiaryApiObject(String name, String country, String currency, String paymentType, String legalEntityType, List<String> allField) {
...
requestMap.put(FIELD_ALL_FIELD, allField);
  ...
  public static BunqResponse<CurrencyCloudBeneficiaryApiObject> get(Integer currencyCloudBeneficiaryId, Map<String, String> params, Map<String, String> customHeaders) {
    ...
    return fromJson(CurrencyCloudBeneficiaryApiObject.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<CurrencyCloudBeneficiaryApiObject> get() {
  ...
  /**
   */
  public static BunqResponse<List<CurrencyCloudBeneficiaryApiObject>> list(Map<String, String> params, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
    BunqResponseRaw responseRaw = apiClient.get(String.format(ENDPOINT_URL_LISTING, determineUserId()), params, customHeaders);

    return fromJsonList(CurrencyCloudBeneficiaryApiObject.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<List<CurrencyCloudBeneficiaryApiObject>> list() {
    return list(null, null);
  }

  public static BunqResponse<List<CurrencyCloudBeneficiaryApiObject>> list(Map<String, String> params) {
  ...
  /**
   */
  public static CurrencyCloudBeneficiaryApiObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(CurrencyCloudBeneficiaryApiObject.class, reader);
  }
