 ...
 */
public class AdditionalTransactionInformationCategoryUserDefinedApiObject extends BunqModel {
  ...
  public AdditionalTransactionInformationCategoryUserDefinedApiObject() {
  this(null, null, null, null, null);
  }

  public AdditionalTransactionInformationCategoryUserDefinedApiObject(String status) {
  this(status, null, null, null, null);
  }

  public AdditionalTransactionInformationCategoryUserDefinedApiObject(String status, String category) {
  this(status, category, null, null, null);
  }

  public AdditionalTransactionInformationCategoryUserDefinedApiObject(String status, String category, String description) {
  this(status, category, description, null, null);
  }

  public AdditionalTransactionInformationCategoryUserDefinedApiObject(String status, String category, String description, String color) {
  this(status, category, description, color, null);
  }

  public AdditionalTransactionInformationCategoryUserDefinedApiObject(String status, String category, String description, String color, String icon) {
...
requestMap.put(FIELD_ICON, icon);
  ...
  /**
   */
  public static AdditionalTransactionInformationCategoryUserDefinedApiObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(AdditionalTransactionInformationCategoryUserDefinedApiObject.class, reader);
  }
