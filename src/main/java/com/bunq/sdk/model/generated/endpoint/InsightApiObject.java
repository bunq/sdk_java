 ...
 */
public class InsightApiObject extends BunqModel {
  ...
  /**
   */
  public static BunqResponse<List<InsightApiObject>> list(Map<String, String> params, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
    BunqResponseRaw responseRaw = apiClient.get(String.format(ENDPOINT_URL_LISTING, determineUserId()), params, customHeaders);

    return fromJsonList(InsightApiObject.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<List<InsightApiObject>> list() {
    return list(null, null);
  }

  public static BunqResponse<List<InsightApiObject>> list(Map<String, String> params) {
  ...
  /**
   */
  public static InsightApiObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(InsightApiObject.class, reader);
  }
