...
/**
 */
public class NotificationFilterObject extends BunqModel {
  ...
  public NotificationFilterObject() {
  this(null, null, null);
  }

  public NotificationFilterObject(String notificationDeliveryMethod) {
  this(notificationDeliveryMethod, null, null);
  }

  public NotificationFilterObject(String notificationDeliveryMethod, String notificationTarget) {
  this(notificationDeliveryMethod, notificationTarget, null);
  }

  public NotificationFilterObject(String notificationDeliveryMethod, String notificationTarget, String category) {
  ...
  /**
   */
  public static NotificationFilterObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(NotificationFilterObject.class, reader);
  }
