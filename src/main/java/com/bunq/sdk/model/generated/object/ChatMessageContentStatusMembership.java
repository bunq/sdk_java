...
public class ChatMessageContentStatusMembership extends BunqModel {
  ...
  /**
   */
  public static ChatMessageContentStatusMembership fromJsonReader(JsonReader reader) {
    return fromJsonReader(ChatMessageContentStatusMembership.class, reader);
  }
