 ...
 */
public class NoteAttachmentBankSwitchServiceNetherlandsIncomingPayment extends BunqModel {
  ...
  public NoteAttachmentBankSwitchServiceNetherlandsIncomingPayment() {
  this(null, null);
  }

  public NoteAttachmentBankSwitchServiceNetherlandsIncomingPayment(Integer attachmentId) {
  this(attachmentId, null);
  }

  public NoteAttachmentBankSwitchServiceNetherlandsIncomingPayment(Integer attachmentId, String description) {
...
requestMap.put(FIELD_DESCRIPTION, description);
  ...
  /**
   */
  public static BunqResponse<NoteAttachmentBankSwitchServiceNetherlandsIncomingPayment> delete(Integer switchServicePaymentId, Integer noteAttachmentBankSwitchServiceNetherlandsIncomingPaymentId, Integer monetaryAccountId, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
  ...
  public static BunqResponse<NoteAttachmentBankSwitchServiceNetherlandsIncomingPayment> delete(Integer switchServicePaymentId) {
    return delete(switchServicePaymentId, null, null, null);
  }

  public static BunqResponse<NoteAttachmentBankSwitchServiceNetherlandsIncomingPayment> delete(Integer switchServicePaymentId, Integer noteAttachmentBankSwitchServiceNetherlandsIncomingPaymentId) {
    return delete(switchServicePaymentId, noteAttachmentBankSwitchServiceNetherlandsIncomingPaymentId, null, null);
  }

  public static BunqResponse<NoteAttachmentBankSwitchServiceNetherlandsIncomingPayment> delete(Integer switchServicePaymentId, Integer noteAttachmentBankSwitchServiceNetherlandsIncomingPaymentId, Integer monetaryAccountId) {
   ...
   */
  public static BunqResponse<List<NoteAttachmentBankSwitchServiceNetherlandsIncomingPayment>> list(Integer switchServicePaymentId, Integer monetaryAccountId, Map<String, String> params, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
    ...
    return fromJsonList(NoteAttachmentBankSwitchServiceNetherlandsIncomingPayment.class, responseRaw, OBJECT_TYPE_GET);
  }
  ...
  public static BunqResponse<List<NoteAttachmentBankSwitchServiceNetherlandsIncomingPayment>> list(Integer switchServicePaymentId) {
    return list(switchServicePaymentId, null, null, null);
  }

  public static BunqResponse<List<NoteAttachmentBankSwitchServiceNetherlandsIncomingPayment>> list(Integer switchServicePaymentId, Integer monetaryAccountId) {
    return list(switchServicePaymentId, monetaryAccountId, null, null);
  }

  public static BunqResponse<List<NoteAttachmentBankSwitchServiceNetherlandsIncomingPayment>> list(Integer switchServicePaymentId, Integer monetaryAccountId, Map<String, String> params) {
    return list(switchServicePaymentId, monetaryAccountId, params, null);
  }

  /**
   */
  public static BunqResponse<NoteAttachmentBankSwitchServiceNetherlandsIncomingPayment> get(Integer switchServicePaymentId, Integer noteAttachmentBankSwitchServiceNetherlandsIncomingPaymentId, Integer monetaryAccountId, Map<String, String> params, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
    ...
    return fromJson(NoteAttachmentBankSwitchServiceNetherlandsIncomingPayment.class, responseRaw, OBJECT_TYPE_GET);
  }
  ...
  public static BunqResponse<NoteAttachmentBankSwitchServiceNetherlandsIncomingPayment> get(Integer switchServicePaymentId) {
    return get(switchServicePaymentId, null, null, null, null);
  }

  public static BunqResponse<NoteAttachmentBankSwitchServiceNetherlandsIncomingPayment> get(Integer switchServicePaymentId, Integer noteAttachmentBankSwitchServiceNetherlandsIncomingPaymentId) {
    return get(switchServicePaymentId, noteAttachmentBankSwitchServiceNetherlandsIncomingPaymentId, null, null, null);
  }

  public static BunqResponse<NoteAttachmentBankSwitchServiceNetherlandsIncomingPayment> get(Integer switchServicePaymentId, Integer noteAttachmentBankSwitchServiceNetherlandsIncomingPaymentId, Integer monetaryAccountId) {
  ...
  public static BunqResponse<NoteAttachmentBankSwitchServiceNetherlandsIncomingPayment> get(Integer switchServicePaymentId, Integer noteAttachmentBankSwitchServiceNetherlandsIncomingPaymentId, Integer monetaryAccountId, Map<String, String> params) {
  ...
  /**
   */
  public static NoteAttachmentBankSwitchServiceNetherlandsIncomingPayment fromJsonReader(JsonReader reader) {
    return fromJsonReader(NoteAttachmentBankSwitchServiceNetherlandsIncomingPayment.class, reader);
  }
