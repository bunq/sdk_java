...
/**
 */
public class TransferwiseRequirementFieldGroupObject extends BunqModel {
  ...
  private TransferwiseRequirementFieldGroupValidationAsyncObject validationAsync;
  ...
  private TransferwiseRequirementFieldGroupValuesAllowedObject valuesAllowed;
   ...
   * Details of an endpoint which may be used to validate the user input.
   */
  public TransferwiseRequirementFieldGroupValidationAsyncObject getValidationAsync() {
    return this.validationAsync;
  }

  public void setValidationAsync(TransferwiseRequirementFieldGroupValidationAsyncObject validationAsync) {
   ...
   * Shows which values are allowed for fields of type "select" or "radio".
   */
  public TransferwiseRequirementFieldGroupValuesAllowedObject getValuesAllowed() {
    return this.valuesAllowed;
  }

  public void setValuesAllowed(TransferwiseRequirementFieldGroupValuesAllowedObject valuesAllowed) {
  ...
  /**
   */
  public static TransferwiseRequirementFieldGroupObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(TransferwiseRequirementFieldGroupObject.class, reader);
  }
