 ...
 */
public class ChatMessageStatus extends BunqModel {
  ...
  /**
   */
  public static ChatMessageStatus fromJsonReader(JsonReader reader) {
    return fromJsonReader(ChatMessageStatus.class, reader);
  }
