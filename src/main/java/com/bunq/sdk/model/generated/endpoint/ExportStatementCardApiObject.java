 ...
 */
public class ExportStatementCardApiObject extends BunqModel {
  ...
  public static BunqResponse<ExportStatementCardApiObject> get(Integer cardId, Integer exportStatementCardId, Map<String, String> params, Map<String, String> customHeaders) {
    ...
    return fromJson(ExportStatementCardApiObject.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<ExportStatementCardApiObject> get() {
  ...
  public static BunqResponse<List<ExportStatementCardApiObject>> list(Integer cardId, Map<String, String> params, Map<String, String> customHeaders) {
    ...
    return fromJsonList(ExportStatementCardApiObject.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<List<ExportStatementCardApiObject>> list() {
  ...
  /**
   */
  public static ExportStatementCardApiObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(ExportStatementCardApiObject.class, reader);
  }
