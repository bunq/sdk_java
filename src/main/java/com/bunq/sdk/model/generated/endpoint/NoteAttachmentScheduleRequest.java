 ...
 */
public class NoteAttachmentScheduleRequest extends BunqModel {
  ...
  public NoteAttachmentScheduleRequest() {
  this(null, null);
  }

  public NoteAttachmentScheduleRequest(Integer attachmentId) {
  this(attachmentId, null);
  }

  public NoteAttachmentScheduleRequest(Integer attachmentId, String description) {
...
requestMap.put(FIELD_DESCRIPTION, description);
  ...
  /**
   */
  public static BunqResponse<NoteAttachmentScheduleRequest> delete(Integer scheduleRequestInquiryId, Integer noteAttachmentScheduleRequestId, Integer monetaryAccountId, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
  ...
  public static BunqResponse<NoteAttachmentScheduleRequest> delete(Integer scheduleRequestInquiryId) {
    return delete(scheduleRequestInquiryId, null, null, null);
  }

  public static BunqResponse<NoteAttachmentScheduleRequest> delete(Integer scheduleRequestInquiryId, Integer noteAttachmentScheduleRequestId) {
    return delete(scheduleRequestInquiryId, noteAttachmentScheduleRequestId, null, null);
  }

  public static BunqResponse<NoteAttachmentScheduleRequest> delete(Integer scheduleRequestInquiryId, Integer noteAttachmentScheduleRequestId, Integer monetaryAccountId) {
   ...
   */
  public static BunqResponse<List<NoteAttachmentScheduleRequest>> list(Integer scheduleRequestInquiryId, Integer monetaryAccountId, Map<String, String> params, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
    ...
    return fromJsonList(NoteAttachmentScheduleRequest.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<List<NoteAttachmentScheduleRequest>> list() {
    return list(null, null, null, null);
  }

  public static BunqResponse<List<NoteAttachmentScheduleRequest>> list(Integer scheduleRequestInquiryId) {
    return list(scheduleRequestInquiryId, null, null, null);
  }

  public static BunqResponse<List<NoteAttachmentScheduleRequest>> list(Integer scheduleRequestInquiryId, Integer monetaryAccountId) {
    return list(scheduleRequestInquiryId, monetaryAccountId, null, null);
  }

  public static BunqResponse<List<NoteAttachmentScheduleRequest>> list(Integer scheduleRequestInquiryId, Integer monetaryAccountId, Map<String, String> params) {
    return list(scheduleRequestInquiryId, monetaryAccountId, params, null);
  }

  /**
   */
  public static BunqResponse<NoteAttachmentScheduleRequest> get(Integer scheduleRequestInquiryId, Integer noteAttachmentScheduleRequestId, Integer monetaryAccountId, Map<String, String> params, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
    ...
    return fromJson(NoteAttachmentScheduleRequest.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<NoteAttachmentScheduleRequest> get() {
    return get(null, null, null, null, null);
  }

  public static BunqResponse<NoteAttachmentScheduleRequest> get(Integer scheduleRequestInquiryId) {
    return get(scheduleRequestInquiryId, null, null, null, null);
  }

  public static BunqResponse<NoteAttachmentScheduleRequest> get(Integer scheduleRequestInquiryId, Integer noteAttachmentScheduleRequestId) {
    return get(scheduleRequestInquiryId, noteAttachmentScheduleRequestId, null, null, null);
  }

  public static BunqResponse<NoteAttachmentScheduleRequest> get(Integer scheduleRequestInquiryId, Integer noteAttachmentScheduleRequestId, Integer monetaryAccountId) {
    return get(scheduleRequestInquiryId, noteAttachmentScheduleRequestId, monetaryAccountId, null, null);
  }

  public static BunqResponse<NoteAttachmentScheduleRequest> get(Integer scheduleRequestInquiryId, Integer noteAttachmentScheduleRequestId, Integer monetaryAccountId, Map<String, String> params) {
  ...
  /**
   */
  public static NoteAttachmentScheduleRequest fromJsonReader(JsonReader reader) {
    return fromJsonReader(NoteAttachmentScheduleRequest.class, reader);
  }
