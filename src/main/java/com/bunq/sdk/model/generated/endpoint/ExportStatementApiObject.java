 ...
 */
public class ExportStatementApiObject extends BunqModel {
  ...
  public ExportStatementApiObject() {
  this(null, null, null, null, null);
  }

  public ExportStatementApiObject(String statementFormat) {
  this(statementFormat, null, null, null, null);
  }

  public ExportStatementApiObject(String statementFormat, String dateStart) {
  this(statementFormat, dateStart, null, null, null);
  }

  public ExportStatementApiObject(String statementFormat, String dateStart, String dateEnd) {
  this(statementFormat, dateStart, dateEnd, null, null);
  }

  public ExportStatementApiObject(String statementFormat, String dateStart, String dateEnd, String regionalFormat) {
  this(statementFormat, dateStart, dateEnd, regionalFormat, null);
  }

  public ExportStatementApiObject(String statementFormat, String dateStart, String dateEnd, String regionalFormat, Boolean includeAttachment) {
...
requestMap.put(FIELD_INCLUDE_ATTACHMENT, includeAttachment);
  ...
  public static BunqResponse<ExportStatementApiObject> get(Integer exportStatementId, Integer monetaryAccountId, Map<String, String> params, Map<String, String> customHeaders) {
    ...
    return fromJson(ExportStatementApiObject.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<ExportStatementApiObject> get() {
  ...
  public static BunqResponse<List<ExportStatementApiObject>> list(Integer monetaryAccountId, Map<String, String> params, Map<String, String> customHeaders) {
    ...
    return fromJsonList(ExportStatementApiObject.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<List<ExportStatementApiObject>> list() {
  ...
  /**
   */
  public static ExportStatementApiObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(ExportStatementApiObject.class, reader);
  }
