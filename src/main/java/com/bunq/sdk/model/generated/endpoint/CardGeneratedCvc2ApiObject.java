 ...
 */
public class CardGeneratedCvc2ApiObject extends BunqModel {
  ...
  public CardGeneratedCvc2ApiObject() {
  this(null);
  }

  public CardGeneratedCvc2ApiObject(String type) {
...
requestMap.put(FIELD_TYPE, type);
  ...
  public static BunqResponse<CardGeneratedCvc2ApiObject> get(Integer cardId, Integer cardGeneratedCvc2Id, Map<String, String> params, Map<String, String> customHeaders) {
    ...
    return fromJson(CardGeneratedCvc2ApiObject.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<CardGeneratedCvc2ApiObject> get() {
...
requestMap.put(FIELD_TYPE, type);
  ...
  public static BunqResponse<List<CardGeneratedCvc2ApiObject>> list(Integer cardId, Map<String, String> params, Map<String, String> customHeaders) {
    ...
    return fromJsonList(CardGeneratedCvc2ApiObject.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<List<CardGeneratedCvc2ApiObject>> list() {
  ...
  /**
   */
  public static CardGeneratedCvc2ApiObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(CardGeneratedCvc2ApiObject.class, reader);
  }
