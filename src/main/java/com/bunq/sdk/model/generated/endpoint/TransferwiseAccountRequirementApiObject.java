 ...
 */
public class TransferwiseAccountRequirementApiObject extends BunqModel {
  ...
  public TransferwiseAccountRequirementApiObject() {
  this(null, null, null, null);
  }

  public TransferwiseAccountRequirementApiObject(String nameAccountHolder) {
  this(nameAccountHolder, null, null, null);
  }

  public TransferwiseAccountRequirementApiObject(String nameAccountHolder, String type) {
  this(nameAccountHolder, type, null, null);
  }

  public TransferwiseAccountRequirementApiObject(String nameAccountHolder, String type, String country) {
  this(nameAccountHolder, type, country, null);
  }

  public TransferwiseAccountRequirementApiObject(String nameAccountHolder, String type, String country, List<TransferwiseRequirementFieldObject> detail) {
...
requestMap.put(FIELD_DETAIL, detail);
  ...
  public static BunqResponse<List<TransferwiseAccountRequirementApiObject>> list(Integer transferwiseQuoteId, Map<String, String> params, Map<String, String> customHeaders) {
    ...
    return fromJsonList(TransferwiseAccountRequirementApiObject.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<List<TransferwiseAccountRequirementApiObject>> list() {
  ...
  /**
   */
  public static TransferwiseAccountRequirementApiObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(TransferwiseAccountRequirementApiObject.class, reader);
  }
