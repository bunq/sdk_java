...
public class TransferwiseTransferRequirementApiObject extends BunqModel {
   ...
   */
  public static BunqResponse<Long> create(Integer transferwiseQuoteId, String recipientId, List<TransferwiseRequirementFieldObject> detail, Map<String, String> customHeaders) {
...
requestMap.put(FIELD_DETAIL, detail);
  ...
  public static BunqResponse<Long> create(Integer transferwiseQuoteId, String recipientId) {
    return create(transferwiseQuoteId, recipientId, null, null);
  }

  public static BunqResponse<Long> create(Integer transferwiseQuoteId, String recipientId, List<TransferwiseRequirementFieldObject> detail) {
