 ...
 */
public class NoteTextPaymentBatch extends BunqModel {
  ...
  public NoteTextPaymentBatch() {
  this(null);
  }

  public NoteTextPaymentBatch(String content) {
...
requestMap.put(FIELD_CONTENT, content);
  ...
  /**
   */
  public static BunqResponse<NoteTextPaymentBatch> delete(Integer paymentBatchId, Integer noteTextPaymentBatchId, Integer monetaryAccountId, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
  ...
  public static BunqResponse<NoteTextPaymentBatch> delete(Integer paymentBatchId) {
    return delete(paymentBatchId, null, null, null);
  }

  public static BunqResponse<NoteTextPaymentBatch> delete(Integer paymentBatchId, Integer noteTextPaymentBatchId) {
    return delete(paymentBatchId, noteTextPaymentBatchId, null, null);
  }

  public static BunqResponse<NoteTextPaymentBatch> delete(Integer paymentBatchId, Integer noteTextPaymentBatchId, Integer monetaryAccountId) {
   ...
   */
  public static BunqResponse<List<NoteTextPaymentBatch>> list(Integer paymentBatchId, Integer monetaryAccountId, Map<String, String> params, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
    ...
    return fromJsonList(NoteTextPaymentBatch.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<List<NoteTextPaymentBatch>> list() {
    return list(null, null, null, null);
  }

  public static BunqResponse<List<NoteTextPaymentBatch>> list(Integer paymentBatchId) {
    return list(paymentBatchId, null, null, null);
  }

  public static BunqResponse<List<NoteTextPaymentBatch>> list(Integer paymentBatchId, Integer monetaryAccountId) {
    return list(paymentBatchId, monetaryAccountId, null, null);
  }

  public static BunqResponse<List<NoteTextPaymentBatch>> list(Integer paymentBatchId, Integer monetaryAccountId, Map<String, String> params) {
    return list(paymentBatchId, monetaryAccountId, params, null);
  }

  /**
   */
  public static BunqResponse<NoteTextPaymentBatch> get(Integer paymentBatchId, Integer noteTextPaymentBatchId, Integer monetaryAccountId, Map<String, String> params, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(getApiContext());
    ...
    return fromJson(NoteTextPaymentBatch.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<NoteTextPaymentBatch> get() {
    return get(null, null, null, null, null);
  }

  public static BunqResponse<NoteTextPaymentBatch> get(Integer paymentBatchId) {
    return get(paymentBatchId, null, null, null, null);
  }

  public static BunqResponse<NoteTextPaymentBatch> get(Integer paymentBatchId, Integer noteTextPaymentBatchId) {
    return get(paymentBatchId, noteTextPaymentBatchId, null, null, null);
  }

  public static BunqResponse<NoteTextPaymentBatch> get(Integer paymentBatchId, Integer noteTextPaymentBatchId, Integer monetaryAccountId) {
    return get(paymentBatchId, noteTextPaymentBatchId, monetaryAccountId, null, null);
  }

  public static BunqResponse<NoteTextPaymentBatch> get(Integer paymentBatchId, Integer noteTextPaymentBatchId, Integer monetaryAccountId, Map<String, String> params) {
  ...
  /**
   */
  public static NoteTextPaymentBatch fromJsonReader(JsonReader reader) {
    return fromJsonReader(NoteTextPaymentBatch.class, reader);
  }
