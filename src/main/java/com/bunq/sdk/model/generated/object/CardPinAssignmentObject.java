...
/**
 */
public class CardPinAssignmentObject extends BunqModel {
  ...
  public CardPinAssignmentObject(String type, String routingType) {
  this(type, routingType, null, null);
  }

  public CardPinAssignmentObject(String type, String routingType, String pinCode) {
  ...
  /**
   */
  public static CardPinAssignmentObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(CardPinAssignmentObject.class, reader);
  }
