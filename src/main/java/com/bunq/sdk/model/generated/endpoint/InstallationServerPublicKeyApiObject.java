 ...
 */
public class InstallationServerPublicKeyApiObject extends BunqModel {
  ...
  public static BunqResponse<List<InstallationServerPublicKeyApiObject>> list(Integer installationId, Map<String, String> params, Map<String, String> customHeaders) {
    ...
    return fromJsonList(InstallationServerPublicKeyApiObject.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<List<InstallationServerPublicKeyApiObject>> list() {
  ...
  /**
   */
  public static InstallationServerPublicKeyApiObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(InstallationServerPublicKeyApiObject.class, reader);
  }
