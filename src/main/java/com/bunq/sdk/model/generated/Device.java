...
public class Device extends BunqModel {
  ...
  public static Device get(ApiContext apiContext, Integer deviceId) {
  ...
  public static Device get(ApiContext apiContext, Integer deviceId,
    ...
    byte[] responseBytes = apiClient.get(String.format(ENDPOINT_URL_READ, deviceId), customHeaders);

    return fromJson(Device.class, new String(responseBytes));
  }
   ...
   */
  public static List<Device> list(ApiContext apiContext, Map<String, String> customHeaders) {
    ApiClient apiClient = new ApiClient(apiContext);
    byte[] responseBytes = apiClient.get(ENDPOINT_URL_LISTING, customHeaders);

    return fromJsonList(Device.class, new String(responseBytes));
  }
