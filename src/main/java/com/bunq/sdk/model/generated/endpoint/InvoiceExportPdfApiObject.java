 ...
 */
public class InvoiceExportPdfApiObject extends BunqModel {
  ...
  public static BunqResponse<InvoiceExportPdfApiObject> get(Integer invoiceId, Integer invoiceExportPdfId, Map<String, String> params, Map<String, String> customHeaders) {
    ...
    return fromJson(InvoiceExportPdfApiObject.class, responseRaw, OBJECT_TYPE_GET);
  }

  public static BunqResponse<InvoiceExportPdfApiObject> get() {
  ...
  /**
   */
  public static InvoiceExportPdfApiObject fromJsonReader(JsonReader reader) {
    return fromJsonReader(InvoiceExportPdfApiObject.class, reader);
  }
